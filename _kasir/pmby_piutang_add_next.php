    ...
    // --------------------
        ...
        if(isset($_POST['btnsimpan'])) {
            ...
            if($txttot=='0') {
                ...
                echo"<script>window.location=('pmby_piutang_add_cetak.php?nobyr=$txtnobyr');</script>";        
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <input type="hidden" name="txttot"  class="form-control" value="<?php echo $tot_bayar; ?>"/>
						
                            <div class="row">
                                <?php include "_template/_pmby_piutang_header_next.php"; ?>
                            </div>
                            
                            <div class="row">
                                <?php include "_template/_pmby_piutang_list_next.php"; ?>                        
                            </div>

                            <div class="row">
                                <?php include "_template/_pmby_piutang_button_next.php"; ?>                                                
                            </div>
