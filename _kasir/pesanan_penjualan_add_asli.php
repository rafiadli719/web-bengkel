			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <form class="form-horizontal" action="cari_pelanggan_jl_pesan.php" method="post" role="form">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-5">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" id="txtnobl" name="txtnobl" class="form-control" 
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Sales :</label>									
                                                        <div class="col-sm-7">
                                                            <select class="col-xs-10 col-sm-12" name="cbosales" id="cbosales" required >
                                                            <option value="">- Pilih -</option>
                                                            <?php
                                                                $sql="select nosales, namasales FROM tblsales order by namasales asc";
                                                                $sql_row=mysqli_query($koneksi,$sql);
                                                                while($sql_res=mysqli_fetch_assoc($sql_row))	
                                                                {
                                                            ?>
                                                            <option value="<?php echo $sql_res["nosales"]; ?>"><?php echo $sql_res["namasales"]; ?></option>
                                                            <?php
                                                                }
                                                            ?>
                                                            </select>
										...
										<div class="widget-main">
														<div class="right">
															<button type="submit" class="btn btn-sm btn-success">
																Simpan & Lanjutkan ke Penambahan Item Barang
