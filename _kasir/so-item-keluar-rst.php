<?php
    ...
    // --------------------
        ...
        if(isset($_POST['btnsimpan'])) {
            ...
            mysqli_query($koneksi,"INSERT INTO tbitem_keluar_header 
            ...
            mysqli_query($koneksi,"UPDATE tbitem_keluar_detail 
                                    SET 
            ...
            while ($tampil = mysqli_fetch_array($sql)) {
                ...
                mysqli_query($koneksi,"INSERT INTO tbstok 
                                        ...
                                        ('6','$LastID','$no_item',
                                        '$txttgl','0','$qty',
                                        'Stok Opname (Keluar)','$kd_cabang')");
            } 
            echo"<script>window.location=('so-keluar-add-cetak.php?nopesanan=$LastID');</script>";                                                                           
        }
?>
...
<div class="row">
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="so-item-keluar-edit-item.php?sid=<?php echo $tampil['id']; ?>">Input/Edit SO</a>
                                                        </li>
                                                        <li>
                                                            <a href="so-item-keluar-hapus-item.php?sid=<?php echo $tampil['id']; ?>" 
                        ...
                        <div class="row">
							...
							<div class="col-xs-12 col-sm-6">
                                                    <a href="so-item-keluar-batal.php?suser=<?php echo $_nama; ?>&scabang=<?php echo $kd_cabang; ?>" 
                                                    onclick="return confirm('Stok Opname (Item Keluar) akan dibatalkan. Lanjutkan?')">                                                                    
