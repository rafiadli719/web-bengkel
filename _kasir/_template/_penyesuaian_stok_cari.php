    ...
    <div class="col-xs-8 col-sm-3">
        ...
        <div class="row">
            <div class="col-xs-8 col-sm-12">    
                ...
                <?php
                    $q = mysqli_query($koneksi,"select id, cari FROM tbcari where tipe='12' order by id asc");
    ...
    <div class="col-xs-8 col-sm-3">
        ...
        <div class="row">
            <div class="col-xs-8 col-sm-12">    
                ...
                <?php
                    $q = mysqli_query($koneksi,"select id, urut FROM tburut where tipe='12' order by id asc");
                    while ($row1 = mysqli_fetch_array($q)){
                        $k_id           = $row1['id'];
                        $k_opis         = $row1['urut'];
                ?>
