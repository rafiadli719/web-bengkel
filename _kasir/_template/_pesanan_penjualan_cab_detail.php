                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pesanan_penjualan_cab_edit_item.php?sid=<?php echo $tampil['id']; ?>&stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $cbocabang; ?>&kd=<?php echo $txtcaribrg; ?>">Edit Item</a>
                                                        </li>
                                                        <li>
                                                            <a href="pesanan_penjualan_cab_hapus_item.php?sid=<?php echo $tampil['id']; ?>&stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $cbocabang; ?>&kd=<?php echo $txtcaribrg; ?>" onclick="return confirm('Item Barang akan dihapus. Lanjutkan?')">Hapus Item</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>	
