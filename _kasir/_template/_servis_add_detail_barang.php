                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="servis_edit_item.php?sid=<?php echo $tampil['id']; ?>&snoserv=<?php echo $no_service; ?>&kd=<?php echo $txtcaribrg; ?>">Edit Item</a>
                                                        </li>
                                                        <li>
                                                            <a href="servis_hapus_item.php?sid=<?php echo $tampil['id']; ?>&snoserv=<?php echo $no_service; ?>&kd=<?php echo $txtcaribrg; ?>" onclick="return confirm('Item Barang akan dihapus. Lanjutkan?')">Hapus Item</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>	
