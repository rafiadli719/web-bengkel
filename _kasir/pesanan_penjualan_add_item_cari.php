							...
							<div class="col-xs-12 col-sm-12">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            <td class="center">
                                                <div bgcolor="<?php echo $bgcolor; ?>" class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pesanan_penjualan_add_rst.php?stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $nopelanggan; ?>&ssales=<?php echo $cbosales; ?>&kd=<?php echo $tampil['noitem']; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                                                                    
                                            </td>														
