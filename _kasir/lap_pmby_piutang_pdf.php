<?php
    ...
    $tglselesai = ubahformatTgl($_GET['stgl2']); 
            ...
            if($nopelanggan=='') {
            // ---- SQL Hasil Data ----- 
                $sql_query="SELECT *, DATE_FORMAT(tanggal,'%d/%m/%Y') AS tanggal_trx FROM view_pembayaran_piutang 
                                    WHERE 
    ...
    $nama_file="Laporan Pembayaran Piutang ".$tgl_pilih_dari." s/d ".$tgl_pilih_sampai.".pdf";
	...
	$html = '<table style="margin: 0 0pt; width: 100%; border-collapse:collapse;" border="0">
                <tr>
                    <td align="center"><b>Laporan Pembayaran Piutang <br>Periode '.$tgl_pilih_dari.' s/d '.$tgl_pilih_sampai.'</b></td>
                </tr>
            </table>
            <br>
