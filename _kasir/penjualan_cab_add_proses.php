								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_tarik_data_pesanan_detail.php"; ?>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_tarik_data_pesanan_lainnya.php"; ?>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_tarik_data_pesanan_total.php"; ?>
