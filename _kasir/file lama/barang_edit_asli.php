					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Satuan Barang </label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Rak Barang </label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        ?>
                                        <option value='<?php echo $k_id; ?>' <?php if ($k_id == $supplier){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
                                        <?php
                                            }
                                        ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Stok Minimum </label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Harga Jual #1 </label>
                                    <div class="col-sm-8">
                                        <input type="text" id="txthjual1" name="txthjual1" class="col-xs-10 col-sm-12" 
                                        value="<?php echo $hargajual; ?>" autocomplete="off" />
                                    </div>
                                </div>                                    
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Harga Jual #2 </label>
                                    <div class="col-sm-8">
                                        <input type="text" id="txthjual2" name="txthjual2" class="col-xs-10 col-sm-12" 
                                        value="<?php echo $hargajual2; ?>" autocomplete="off" />
                                    </div>
                                </div>                                    
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Harga Jual #3 </label>
                                    <div class="col-sm-8">
                                        <input type="text" id="txthjual3" name="txthjual3" class="col-xs-10 col-sm-12" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="col-xs-10 col-sm-12" id="txtnote" name="txtnote" rows="5"><?php echo $note; ?></textarea>
                                    </div>
                                </div>
							</div>									
                        </div>
