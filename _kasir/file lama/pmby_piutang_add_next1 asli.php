			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <form class="form-horizontal" action="pmby_piutang_print.php" method="post" role="form">
                                                ...
                                                <div class="col-xs-12 col-sm-5">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <?php
                                                                $q = mysqli_query($koneksi,"select nopelanggan, namapelanggan FROM tblpelanggan");
                                                                while ($row1 = mysqli_fetch_array($q)){
                                                                    $k_id           = $row1['nopelanggan'];
                                                                    $k_opis         = $row1['namapelanggan'];
                                                            ?>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-default">
                                                                    <li>
                                                                        ...
                                                                        nobyr=<?php echo $tampil['no_transaksi']; ?>&nobl=<?php echo $tampil['no_penjualan']; ?>&jml=<?php echo $kekurangan; ?>">Edit Jumlah Bayar</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="hapus_bayar_hutang.php?
                                                                        nobyr=<?php echo $tampil['no_transaksi']; ?>
                                                                        &nobl=<?php echo $tampil['$no_penjualan']; ?>">Hapus Faktur Penjualan</a>
                                                                    </li>
                                                                </ul>
                                                            </div><!-- /.btn-group -->                                                                                                                
                                                        </td>
