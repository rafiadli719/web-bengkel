<?php
   ...
   // end cari ==============
    ...
    // urut ==============
        ...
        if($txturut=='33') {
            $sql_urut="total_bayar";
        }
    // end urut ==============
        
        if($txtflt=='asc') {
            $sql_query=" SELECT * FROM view_pembayaran_piutang 
                        WHERE ".$sql_cari." like '%".$txtkey."%' order by ".$sql_urut." asc";
            //echo $sql_query;
            $cari_kd=mysqli_query($koneksi,"SELECT 
                                            count(*) as tot FROM view_pembayaran_piutang 
		...
		if(isset($_POST['btnasc'])) {				
			...
			echo"<script>window.location=('pmby_piutang_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
			echo"<script>window.location=('pmby_piutang_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";            
        }
?>
											...
											<form class="form-horizontal" action="" method="post">	
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        <select class="col-xs-10 col-sm-12" name="cbocari" id="cbocari" >
                                                            ...
                                                            <?php
                                                                $q = mysqli_query($koneksi,"select id, cari FROM tbcari where tipe='7' order by id asc");
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, urut FROM tburut where tipe='7' order by id asc");
                                                            while ($row1 = mysqli_fetch_array($q)){
                                                                $k_id           = $row1['id'];
                                                                $k_opis         = $row1['urut'];
                                                        ?>
                        ...
                        <div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="table-header">
                                    									<a href="pmby_piutang_add.php"><font color="white">[ Input Pembayaran Piutang ]</font></a>
								</div>                            
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a target="_blank"  href="pembayaran_piutang_struk.php?snotrx=<?php echo $tampil['no_transaksi']; ?>">Cetak</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>														
