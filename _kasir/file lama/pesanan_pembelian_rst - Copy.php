<?php
   ...
   // cari ==============
        if($txtcari=='') {
            ...
            if($txtcari=='2') {
                $sql_cari="no_supplier";
            }
            if($txtcari=='3') {
                $sql_cari="namasupplier";
            }
        }
   // end cari ==============
    ...
    // urut ==============
        ...
        if($txturut=='2') {
            $sql_urut="no_supplier";
        }
        if($txturut=='3') {
            $sql_urut="namasupplier";
        }
        if($txturut=='4') {
            $sql_urut="total_qty";
        }
    // end urut ==============
        ...
        if($txtflt=='asc') {
            ...
            //echo $sql_query;
            $cari_kd=mysqli_query($koneksi,"SELECT 
                                            count(*) as tot FROM view_pesanan_pembelian_header 
		...
		if(isset($_POST['btnasc'])) {				
			...
			echo"<script>window.location=('pesanan_pembelian_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
			echo"<script>window.location=('pesanan_pembelian_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";            
        }
?>
											...
											<form class="form-horizontal" action="" method="post">	
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, cari FROM tbcari where tipe='1' order by id asc");
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, urut FROM tburut where tipe='1' order by id asc");
                                                            while ($row1 = mysqli_fetch_array($q)){
                                                                $k_id           = $row1['id'];
                                                                $k_opis         = $row1['urut'];
                                                        ?>
                        ...
                        <div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="table-header">
									<a href="pesanan_pembelian_add.php"><font color="white">[ Tambah Pesanan Pembelian ]</font></a>
								</div>                                                        
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="center" width="5%"></th>
                                            <th class="center" width="10%">No. Pesanan</th>
                                            <th class="center" width="10%">Tanggal</th>
                                            <th width="10%">Kode Supplier</th>
                                            <th width="25%">Nama Supplier</th>
                                            <th class="center" width="10%">Total Qty</th>
...
//		$cari_kd=mysqli_query($koneksi,"SELECT cabang_tipe FROM tbcabang_tipe 
														...
														<td class="center">
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-default">
                                                                    <li>
                                                                        <a href="pesanan_pembelian_detail.php?nopesanan=<?php echo $tampil['no_order']; ?>">Detail Pesanan</a>
                                                                    </li>
                                                                    <li>
                                                                        <a target="_blank" href="pesanan_pembelian_struk.php?snopesanan=<?php echo $tampil['no_order']; ?>">Cetak</a>
                                                                    </li>
                                                                </ul>
                                                            </div><!-- /.btn-group -->                                                        
                                                        </td>														
