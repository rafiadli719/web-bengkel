						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-header">
									<a href="barang_add.php"><font color="white">[ Tambah ]</font></a>
								</div>
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												?>
													<tr>
														...
														<td><?php echo $tampil['rakbarang']?></td>														
														<td><?php echo $tampil['supplier']?></td>														                                                                                                                
														<td class="center">													
															<a class="green" data-rel="tooltip" title="Edit" 
																href="barang_edit.php?kd=<?php echo $tampil['noitem']?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>&nbsp;
															<a class="red" data-rel="tooltip" title="Delete" 
																href="barang_del.php?kd=<?php echo $tampil['noitem']?>" 
																onclick="return confirm('Data Barang akan dihapus. Lanjutkan?')">
