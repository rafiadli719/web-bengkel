<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {				
			...
			echo"<script>window.location=('pembelian_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
			echo"<script>window.location=('pembelian_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";            
        }
?>
											...
											<form class="form-horizontal" action="" method="post">	
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, cari FROM tbcari where tipe='2' order by id asc");
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, urut FROM tburut where tipe='2' order by id asc");
                                                            while ($row1 = mysqli_fetch_array($q)){
                                                                $k_id           = $row1['id'];
                                                                $k_opis         = $row1['urut'];
                                                        ?>
                        ...
                        <div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="table-header">
									<a href="pembelian_add.php"><font color="white">[ Tambah Pembelian ]</font></a>
								</div>                                                        
														...
														<td class="center">
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-default">
                                                                    <li>
                                                                        <a href="pembelian_detail.php?nopesanan=<?php echo $tampil['notransaksi']; ?>">Detail Pembelian</a>
                                                                    </li>
                                                                    <li>
