                                            ...
                                            <td bgcolor="<?php echo $bgcolor; ?>" class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="penjualan_add_rst.php?stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $nopelanggan; ?>&ssales=<?php echo $cbosales; ?>&kd=<?php echo $tampil['noitem']; ?>&spesan=<?php echo $spesan; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                                                                    
                                            </td>														
