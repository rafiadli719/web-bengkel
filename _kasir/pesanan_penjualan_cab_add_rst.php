    ...
    // Total Transaksi ======
		...
		if(isset($_POST['btncari'])) {				
            ...
            if($tot_cari=='1') {
                ...
                $cbocari="";
                $cbourut="35";
                echo"<script>window.location=('pesanan_penjualan_cab_add_item_cari.php?stgl=$tgl_pilih&ssup=$cbocabang&_key=$txtcaribrg&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
            }
        ...
        if(isset($_POST['btnsimpan'])) {
            ...
            $total_qty_order=$tm_cari['tot_qty_jual'];                                 
                ...
                echo"<script>window.location=('pesanan_penjualan_cab_cetak.php?nopesanan=$LastID');</script>";        
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Buat Pesanan</li>
						</ul><!-- /.breadcrumb -->
					</div>
