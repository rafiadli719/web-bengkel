						...
						<div class="row">
							<div class="col-xs-12 col-sm-3">
								<center>
								    ...
								    <br>&nbsp;
                                    <form class="form-horizontal" enctype="multipart/form-data" action="pegawai_view_upload.php" method="get">
        								<input type="hidden" name="kd"  class="form-control" value="<?php echo $nip; ?>"/>
                                        <div class="form-group">
    										<div class="col-xs-12">
                                                <p>
                                                    <button class="btn btn-danger btn-block" type="submit">Ubah Photo</button>
                                                </p>                                            
    									    </div>
    									</div>															
    					            </form>								    
