					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-8">
								...
								<form class="" action="absensi_import_proses.php" method="post">							
...
//$objPHPExcel->$loadexcel->getActiveSheet()->getCellByColumnAndRow(1, 8)->getValue();

														// Buat sebuah div untuk alert validasi kosong
														echo "<div class='alert alert-danger' id='kosong'>
														Preview Data Absensi Hasil Import Dari Excel.
														</div>";	
												?>
...
//}
														...
														foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
															...
															if($numrow > 1){
																...
																if($fld1 == "" or $fld2 == "" or $fld3 == "" or $fld4 == "" or $fld5 == "" or $fld6 == ""){
																	$kosong++; // Tambah 1 variabel $kosong
																}

																echo "<tr>";
																echo "<td".$fld1_td.">".$fld1."</td>";
																echo "<td".$fld2_td.">".$fld2."</td>";
																echo "<td".$fld3_td.">".$fld3."</td>";
																echo "<td".$fld4_td.">".$fld4."</td>";
																echo "<td".$fld5_td.">".$fld5."</td>";
																echo "<td".$fld6_td.">".$fld6."</td>";
																echo "</tr>";
															}
							...
							<div class="col-xs-12 col-sm-4">
											<div class='alert alert-danger' id='kosong'>
														Tabel Referensi Status Kehadiran.
														</div>
											<table id="dynamic-table" class="table table-bordered">
												<thead>
													<tr>
														<th class="center" width="20%">Kode</th>
														<th width="80%">Status Kehadiran</th>
													</tr>
												</thead>
												<tbody>
												<?php 
													$sql = mysqli_query($koneksi,"SELECT id, status_kehadiran FROM tbstatus_kehadiran");
													while ($tampil = mysqli_fetch_array($sql)) {
												?>
													<tr>
														<td class="center"><?php echo $tampil['id']?></td>
														<td><?php echo $tampil['status_kehadiran']?></td>
													</tr>
