				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Informasi Pendidikan</li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php echo $nip; ?> - <?php echo $nama; ?>
								</h4>
								<div class="table-header">
								<a href="pegawai_education_add.php?nip=<?php echo $nip; ?>"><font color="white">[ New ]</font></a>
								&nbsp;
								<a href="pegawai.php"><font color="white">[ Close ]</font></a>
								</div>
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th width="15%">Education Level Name</th>
														<th width="20%">Education Field Name</th>
													...
													<tr>
														...
														<td class="center">													
															<a class="green" data-rel="tooltip" title="Edit" 
																href="pegawai_education_edit.php?kd=<?php echo $tampil['id']?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>&nbsp;
															<a class="red" data-rel="tooltip" title="Delete" 
																href="pegawai_education_del.php?kd=<?php echo $tampil['id']?>" 
