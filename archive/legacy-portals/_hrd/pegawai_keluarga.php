					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<a href="pegawai_keluarga_add.php?nip=<?php echo $nip; ?>"><font color="white">[ New ]</font></a>
								&nbsp;
													...
													<tr>
														...
														<td class="center">													
															<a class="green" data-rel="tooltip" title="Edit" 
																href="pegawai_keluarga_edit.php?kd=<?php echo $tampil['id']?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>&nbsp;
															<a class="red" data-rel="tooltip" title="Delete" 
																href="pegawai_keluarga_del.php?kd=<?php echo $tampil['id']?>" 
