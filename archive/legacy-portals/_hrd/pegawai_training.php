					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<a href="pegawai_training_add.php?nip=<?php echo $nip; ?>"><font color="white">[ New ]</font></a>
								&nbsp;
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th width="35%">Training Institution</th>
													...
													<tr>
														...
														<td class="center">													
															<a class="green" data-rel="tooltip" title="Edit" 
																href="pegawai_training_edit.php?kd=<?php echo $tampil['id']?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>&nbsp;
															<a class="red" data-rel="tooltip" title="Delete" 
																href="pegawai_training_del.php?kd=<?php echo $tampil['id']?>" 
