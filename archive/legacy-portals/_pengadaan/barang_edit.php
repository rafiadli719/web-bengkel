<?php
    ...
    // --------------------        
        ...
        $txtstokawal= $tm_cari['inv_jmlawal'];

        $stok_maks= $tm_cari['stok_maks'];
        $cbopabrik= $tm_cari['kd_pabrik'];
        $cboetalase= $tm_cari['kd_etalase'];
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						<br>
                        <form class="form-horizontal" action="barang_edit_proses.php" method="post">
							...
							<div class="col-xs-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        value="<?php echo $kodebarcode; ?>" autocomplete="off" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        value="<?php echo $txtqty2; ?>" autocomplete="off" />
                                        ...
                                        value="<?php echo $hargajual; ?>" autocomplete="off" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        value="<?php echo $txtqty3; ?>" autocomplete="off" />
                                        <label class="col-xs-2 control-label no-padding-center" for="form-field-1"> s/d </label>
                                        <input type="text" id="txtqty2b" name="txtqty2b" class="col-xs-2" 
                                        value="<?php echo $txtqty4; ?>" autocomplete="off" />
                                        <label class="col-xs-2 control-label no-padding-right" for="form-field-1"> Harga &nbsp;</label>
                                        <input type="text" id="txthj2" name="txthj2" class="col-xs-4" 
                                        value="<?php echo $hargajual2; ?>" autocomplete="off" />
                                    </div>
                                </div>
                                <div class="form-group">
							...
							<div class="col-xs-12 col-sm-12">
                                <div class="tabbable">
                                    <ul class="nav nav-tabs padding-18 tab-size-bigger" id="myTab">
                                        <li class="active">
                                            <a data-toggle="tab" href="#faq-tab-1">Informasi Inventori</a>
                                        </li>
                                        <li>
                                            <a data-toggle="tab" href="#faq-tab-2">Applicable Part</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content no-border padding-24">
                                        ...
                                        ?>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Stok Minimum </label>
                                                    <div class="col-sm-8">
                                                        <input type="text" id="txtstokmin" name="txtstokmin" class="col-xs-10 col-sm-12" 
                                                        value="<?php echo $stokmin; ?>" autocomplete="off" />
                                                    </div>
                                                </div>   
                                               <div class="form-group">
                                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Stok Maksimal </label>
                                                    <div class="col-sm-8">
                                                        <input type="text" id="txtstokmaks" name="txtstokmaks" class="col-xs-10 col-sm-12" 
                                                        value="<?php echo $stok_maks; ?>" autocomplete="off" />
                                                    </div>
                                                </div>                                                   
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Rak </label>
                                                    <div class="col-sm-8">
                                                        <select class="col-xs-10 col-sm-12" name="cborak" id="cborak" >
                                                        <option value="">- Pilih -</option>
                                                        <?php
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Etalase </label>
                                                    <div class="col-sm-8">
                                                        <select class="col-xs-10 col-sm-12" name="cboetalase" id="cboetalase" >
                                                        <option value="">- Pilih -</option>
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select kode_cabang, nama_cabang FROM tbcabang");
                                                            while ($row1 = mysqli_fetch_array($q)){
                                                                $k_id           = $row1['kode_cabang'];
                                                                $k_opis         = $row1['nama_cabang'];
                                                        ?>
                                                        <option value='<?php echo $k_id; ?>' <?php if ($k_id == $cboetalase){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
                                                        <?php
                                                            }
                                                        ?>
                                                        </select>
                                            ...
                                            <div class="col-xs-5">
                                                <div class="form-group">
                                                    <label class="col-sm-12 control-label no-padding-right" for="form-field-1"> Saldo Awal </label>
                                                </div>   
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Jumlah Stok </label>
                                                    <div class="col-sm-8">
                                                        <input type="text" id="txtstokawal" name="txtstokawal" class="col-xs-10 col-sm-12" 
                                                        value="<?php echo $txtstokawal; ?>" autocomplete="off" />
                                                    </div>
                                                </div>   
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        value="<?php echo $hargapokok; ?>" autocomplete="off" />
                                                    </div>
                                                </div>                                                                                        
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Total Pokok </label>
                                                    <div class="col-sm-8">
                                                        <input type="text" id="txttotalpokok" name="txttotalpokok" class="col-xs-10 col-sm-12" 
                                                        disabled />
                                                    </div>
                                                </div>   
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> per Tanggal </label>
                                                    <div class="col-sm-8">
                                                        <input type="text" id="txttglstok" name="txttglstok" class="col-xs-10 col-sm-12" 
                                                        disabled />
                                                    </div>
                                                </div>                                                   
                                            </div>
                                            <div class="col-xs-2">
                                                <div class="form-group">
                                                    <label class="col-sm-12 control-label no-padding-right" for="form-field-1"> Sampai saat ini </label>
                                                </div>                                                                                                                                    
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <input type="text" id="txtstokakhir" name="txtstokakhir" class="col-xs-10 col-sm-12" 
                                                        disabled />
                                                    </div>
                                                </div>   
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <input type="text" id="txthpokok_skr" name="txthpokok_skr" class="col-xs-10 col-sm-12" 
						...
						<div class="row">
							<div class="col-xs-6">
                                <p>
                                    <button class="btn btn-danger btn-block" type="submit">Simpan Barang</button>
                                </p>
                            </div>
							<div class="col-xs-6">
                                <p>
