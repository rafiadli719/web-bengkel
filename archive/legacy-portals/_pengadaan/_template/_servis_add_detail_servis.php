                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="servis_edit_paket.php?sid=<?php echo $tampil['id']; ?>&snoserv=<?php echo $no_service; ?>&kd=<?php echo $txtcarisrv; ?>">Edit Item</a>
                                                        </li>
                                                        <li>
                                                            <a href="servis_hapus_paket.php?sid=<?php echo $tampil['id']; ?>&snoserv=<?php echo $no_service; ?>&kd=<?php echo $txtcarisrv; ?>" onclick="return confirm('Item Paket akan dihapus. Lanjutkan?')">Hapus Item</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>	
