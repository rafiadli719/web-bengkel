                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pembelian_edit_item.php?sid=<?php echo $tampil['id']; ?>&stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $cbo_supplier; ?>&spesan=<?php echo $nopesanan; ?>">Edit Item</a>
                                                        </li>
                                                        <li>
                                                            <a href="pembelian_hapus_item.php?sid=<?php echo $tampil['id']; ?>&stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $cbo_supplier; ?>&spesan=<?php echo $nopesanan; ?>" 
