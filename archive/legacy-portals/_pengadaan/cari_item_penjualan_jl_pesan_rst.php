<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {				
			...
			echo"<script>window.location=('cari_item_penjualan_jl_pesan_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc&_nopesan=$txtnoorder');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbourut= $_POST['cbourut'];
            $txtnoorder= $_POST['txtnoorder'];
			echo"<script>window.location=('cari_item_penjualan_jl_pesan_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc&_nopesan=$txtnoorder');</script>";            
        }
?>
									...
									<div class="widget-body">
										<div class="widget-main">	
											<form class="form-horizontal" action="" method="post">	
                                                    ...
                                                    class="form-control" value="<?php echo $txtnoorder; ?>"/>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">	
                                            ...
                                            <h2><?php echo number_format($tot,0); ?></h2>										</div>
									</div>
								</div>	
							</div>
						</div>
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pesanan_penjualan_add_next_rst.php?kd=<?php echo $tampil['noitem']; ?>&noorder=<?php echo $txtnoorder; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>														
