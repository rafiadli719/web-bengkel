<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {	
            ...
            echo"<script>window.location=('paket_add_jasa_cari.php?snamawo=$snamawo&sketwo=$sketwo&_keyjasa=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc&swaktu=$swaktu');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
            echo"<script>window.location=('paket_add_jasa_cari.php?snamawo=$snamawo&sketwo=$sketwo&_keyjasa=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc&swaktu=$swaktu');</script>";            
        }
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="">Work Order / Paket</a>
							</li>                                                                                    
							<li class="active">Cari Item Jasa</li>
						</ul><!-- /.breadcrumb -->
					</div>
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <form class="form-horizontal" action="" method="post" role="form">        
                                                <input type="hidden" name="txtnamawo"  class="form-control" value="<?php echo $snamawo; ?>"/>                        
                                                <input type="hidden" name="txtketwo"  class="form-control" value="<?php echo $sketwo; ?>"/>                                                                        
                                                <input type="hidden" name="txtwaktu"  class="form-control" value="<?php echo $swaktu; ?>"/>                                                                                                                                                                        
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="paket_add_rst.php?snamawo=<?php echo $snamawo; ?>&kd=<?php echo $kdbrg; ?>&kdjasa=<?php echo $tampil['noitem']; ?>&sketwo=<?php echo $sketwo; ?>&swaktu=<?php echo $swaktu; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                                                                    
                                            </td>														
