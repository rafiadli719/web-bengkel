...
<?php include "menu_kendaraan05.php"; ?>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Warna Motor</li>
						</ul><!-- /.breadcrumb -->
					</div>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-header">
									<a href="motor_warna_add.php"><font color="white">[ Tambah ]</font></a>
								</div>
										<div>
...
<td></td>														
														<td class="center">													
															...
															<a class="red" data-rel="tooltip" title="Delete" 
																href="motor_warna_del.php?kd=<?php echo $tampil['id']?>" 
																onclick="return confirm('Data Warna Motor akan dihapus. Lanjutkan?')">
