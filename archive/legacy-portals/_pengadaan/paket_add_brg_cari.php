                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="paket_add_rst.php?snamawo=<?php echo $snamawo; ?>&kd=<?php echo $tampil['noitem']; ?>&kdjasa=<?php echo $kdjasa; ?>&sketwo=<?php echo $sketwo; ?>&swaktu=<?php echo $swaktu; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                                                                    
                                            </td>														
