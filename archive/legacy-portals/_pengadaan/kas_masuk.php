						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-header">
									<a href="kas_masuk_add.php"><font color="white">[ Tambah ]</font></a>
								</div>
										<div>
													...
													<tr>
														...
														<td class="center">													
															<a class="green" data-rel="tooltip" title="Edit" 
																href="kas_masuk_edit.php?kd=<?php echo $tampil['kode_km']?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>&nbsp;
															<a class="red" data-rel="tooltip" title="Delete" 
																href="kas_masuk_del.php?kd=<?php echo $tampil['kode_km']?>" 
																onclick="return confirm('Data Kas Masuk akan dihapus. Lanjutkan?')">
