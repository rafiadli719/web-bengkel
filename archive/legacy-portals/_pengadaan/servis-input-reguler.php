...
//                window.location=('servis-input-reguler-rst.php?snoserv=$no_service&kd=$txtcaribrg&kdjasa=$txtcarisrv');
//                </script>";        
//            } else {
                if($tot_cari=='1') {
...
//            } else {
            ...
            // == Total dari Item & Waktu Service ==============
                ...
                // == Total dari Item Barang ==============
                    ...
                    $cbocari="";
                    $cbourut="35";
                    echo"<script>window.location=('servis-add-item-cari.php?&snoserv=$no_service&_key=$txtcarisrv&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
                }                
  //          }
        }            
