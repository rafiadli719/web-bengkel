        ...
        if($txtflt=='asc') {
            IF($sql_cari=="") {
                $sql_query="SELECT * FROM view_cari_kendaraan 
                            WHERE 
                            (nopolisi like '%".$txtkey."%') OR 
                            (pemilik like '%".$txtkey."%') OR 
											...
											<form class="form-horizontal" action="" method="post">	
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, cari FROM tbcari where tipe='9' order by id asc");
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, urut FROM tburut where tipe='9' order by id asc");
                                                            while ($row1 = mysqli_fetch_array($q)){
                                                                $k_id           = $row1['id'];
                                                                $k_opis         = $row1['urut'];
                                                        ?>
                        ...
                        <div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="table-header">
									<a href="kendaraan_add.php"><font color="white">[ Tambah Kendaraan ]</font></a>
								</div>                            
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="kendaraan_edit.php?kd=<?php echo $tampil['nopolisi']?>">Edit Kendaraan</a>
                                                        </li>
                                                        <li>
                                                            <a href="kendaraan_del.php?kd=<?php echo $tampil['nopolisi']?>" 
                                                            onclick="return confirm('Data Kendaraan akan dihapus. Lanjutkan?')">Hapus</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a href="kendaraan-history.php?kd=<?php echo $tampil['nopolisi']?>">History Kendaraan</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>														
                                            ...
                                            <td class="center"><?php echo $tampil['merek']?></td>														                                                                                                                
