			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <form class="form-horizontal" action="save_piutang_d.php" method="post" role="form">
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <div class="row">
												...
												<tbody>
												<?php 
													$sql = mysqli_query($koneksi,"SELECT * FROM tblpenjualan_header 
                                                                                WHERE 
                                                                                no_pelanggan='$no_supplier' and 
                                                                                carabayar='Kredit'");
