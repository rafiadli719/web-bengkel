...
<?php include "menu_penjualan03.php"; ?>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
                            ...
                            <li>
								<a href="pesanan_penjualan.php">Pesanan Penjualan</a>
							</li>                            
					...
					<div class="page-content">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-5">
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label no-padding-right" for="txtnopesanan"> No. Penjualan :</label>									
                                                        <div class="col-sm-7">
                                                            <input type="text" class="form-control" value="<?php echo $nobl; ?>" disabled />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                ...
                                                                value="<?php echo $tanggal_order; ?>" autocomplete="off" disabled data-date-format="dd/mm/yyyy" />
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="col-xs-10 col-sm-12" name="cbosales" id="cbosales" disabled >
                                                            ...
                                                            ?>
                                                            <option value='<?php echo $k_id; ?>' <?php if ($k_id == $no_sales){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
                                                            <?php
                                                                }
                                                            ?>
                                                            </select>
                                                ...
                                                <div class="col-xs-12 col-sm-5">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            value="<?php echo $user_order; ?>" disabled />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" id="txtkey" name="txtkey" class="col-xs-10 col-sm-12" 
                                                             value="<?php echo $namapelanggan; ?>" disabled />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
							...
							<div class="col-xs-12 col-sm-12">
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">	
                                            <div class="row">
                                                <form class="form-horizontal" action="cari_item_penjualan_jl_pesan.php" method="post" role="form">                                            
                                                    <input type="hidden" name="txtnoorder" 
                                                    class="form-control" value="<?php echo $nobl; ?>"/>
                                                    <div class="col-xs-12 col-sm-3">
                                                        <div class="input-group">
                                                            <input type="text" id="txtcaribrg" name="txtcaribrg" 
                                                            class="form-control search-query" placeholder="Masukkan Kode/Nama Item.." 
                                                    ...
                                                    <div class="col-xs-12 col-sm-2">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                class="col-xs-10 col-sm-12" required autocomplete="off" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-2">
                        ...
                        <form class="form-horizontal" action="save_pesanan_penjualan.php" method="post" role="form">
                        ...
                        <div class="row">
							...
							<div class="col-xs-12 col-sm-4">
                                <div class="form-group">
                                    <label class="col-sm-6 control-label no-padding-right" for="form-field-1"> Sub Total : </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-6 control-label no-padding-right" for="form-field-1"> Potongan Faktur : </label>
                                    <div class="col-sm-2">
                                        <input type="text" class="col-xs-10 col-sm-12" 
                                        value="0" 
                                        id="txtpotfaktur_persen" name="txtpotfaktur_persen" autocomplete="off" />
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="col-xs-10 col-sm-12" 
                                        value="0" 
                                        id="txtpotfaktur_nom" name="txtpotfaktur_nom" autocomplete="off" />
                                    </div>
                                </div>                                                            
                                <div class="form-group">
                                    <label class="col-sm-6 control-label no-padding-right" for="form-field-1"> Pajak : </label>
                                    <div class="col-sm-2">
                                        <input type="text" class="col-xs-10 col-sm-12" 
                                        value="0" 
                                        id="txtpajak_persen" name="txtpajak_persen" autocomplete="off" />
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="col-xs-10 col-sm-12" 
                                        value="0" 
                                        id="txtpajak_nom1" name="txtpajak_nom1" disabled />
                                ...
                                <div class="form-group">
                                    <label class="col-sm-6 control-label no-padding-right" for="form-field-1"> Total Netto : </label>
                                    <div class="col-sm-6">
                                        <input type="text" class="col-xs-10 col-sm-12" 
                                        id="txtnet1" name="txtnet1" value="<?php echo number_format($tot,0)?>" disabled />
                                ...
                                <div class="form-group">
                                    <label class="col-sm-6 control-label no-padding-right" for="form-field-1"> DP/Uang Muka : </label>
                                    <div class="col-sm-6">
                                        <input type="text" class="col-xs-10 col-sm-12" 
                                        value="0" id="txtdp" name="txtdp" autocomplete="off" />
                                    </div>
                                </div>                                                                                                                     
                                <div class="form-group">
                                    <label class="col-sm-6 control-label no-padding-right" for="form-field-1"> Kekurangan : </label>
                                    <div class="col-sm-6">
                                        <input type="text" class="col-xs-10 col-sm-12" 
