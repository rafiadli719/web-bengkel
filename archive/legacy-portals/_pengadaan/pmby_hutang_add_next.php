				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
                            ...
                            <li>
								<a href="pmby_hutang.php">Pembayaran Hutang</a>
							</li>                            
					...
					<div class="page-content">
                        ...
                        <input type="hidden" name="txttot"  class="form-control" value="<?php echo $tot_bayar; ?>"/>
                            ...
                            <div class="row">
                                <?php include "_template/_pmby_hutang_header_next.php"; ?>
                            </div>
                            
                            <div class="row">
                                <?php include "_template/_pmby_hutang_list_next.php"; ?>                        
                            </div>

                            <div class="row">
                                <?php include "_template/_pmby_hutang_button_next.php"; ?>                                                
                            </div>
