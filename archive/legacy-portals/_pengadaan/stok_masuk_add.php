<?php
    ...
    // --------------------
        ...
        if(isset($_POST['btnadd'])) {	
            ...
            if($txtkdbarang<>'') {
                $data = mysqli_query($koneksi,"SELECT * FROM tbitem_masuk_detail 
                                                WHERE 
                ...
                if($cek > 0){
                    ...
                    window.location=('stok_masuk_add_rst.php?stgl=$tgl_pilih&kd=$kdbrg');</script>";			            
                } else {    
                    // cek stok disini
                    // jika kurang atau =0                    
                    // tolak
                ...
                // ------ Stok ----------
                    ...
                    while ($tampil = mysqli_fetch_array($sql)) {
                        ...
                        mysqli_query($koneksi,"INSERT INTO tbstok 
                                            ...
                                            ('5','$LastID','$no_item',
                                            '$txttglpesan','$qty','0',
                                            'Penyesuaian Stok Item Masuk','$kd_cabang')");
                        }                                                
                        echo"<script>window.location=('stok_masuk_add_cetak.php?nopesanan=$LastID');</script>";                            
                    }                
            }
        }             
?>
...
<div class="space space-8"></div>                            
							...
							<div class="col-xs-12 col-sm-3">
                                <a href="stok_masuk_batal.php?suser=<?php echo $_nama; ?>&scabang=<?php echo $kd_cabang; ?>" 
