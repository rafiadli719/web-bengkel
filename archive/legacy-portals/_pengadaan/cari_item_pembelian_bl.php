<?php
    ...
    // --------------------        
		...
		if(isset($_POST['btnasc'])) {				
			...
			$txtnoorder= $_POST['txtnoorder'];            
			echo"<script>window.location=('cari_item_pembelian_bl_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc&_nopesan=$txtnoorder');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbourut= $_POST['cbourut'];
			$txtnoorder= $_POST['txtnoorder'];            
			echo"<script>window.location=('cari_item_pembelian_bl_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc&_nopesan=$txtnoorder');</script>";            
        }
?>
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pembelian_add_next_rst.php?kd=<?php echo $tampil['noitem']; ?>&noorder=<?php echo $txtnoorder; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>														
