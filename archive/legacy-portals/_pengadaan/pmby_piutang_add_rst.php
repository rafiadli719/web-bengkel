    ...
    // Tampilkan Faktur Penjualan ==========
		...
		if(isset($_POST['btncari_pelanggan'])) {
            ...
            if($tot_cari=='1') {
                ...
                $cbocari="";
                $cbourut="23";
                echo"<script>window.location=('pmby_piutang_add_pelanggan_cari.php?stgl=$tgl_pilih&ssup=$nopelanggan&_key=$nopelanggan&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";                
            }
        }
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <input type="hidden" name="txtuser"  class="form-control" value="<?php echo $_nama; ?>"/>
                            ...
                            <div class="row">
                                <?php include "_template/_pmby_piutang_header.php"; ?>
                            </div>
                            
                            <div class="row">
                                <?php include "_template/_pmby_piutang_list.php"; ?>                        
                            </div>

                            <div class="row">
                                <?php include "_template/_pmby_piutang_button.php"; ?>                                                
                            </div>
