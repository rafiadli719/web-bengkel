			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <form class="form-horizontal" action="pmby_hutang_print.php" method="post" role="form">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-5">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" class="form-control" value="<?php echo $nobyr; ?>" disabled />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
										...
										<div class="widget-main">	
                                            <div class="row">
                                                ...
                                                <div class="table-header">
                                                    List Faktur Pembelian
                                                </div>                                                        
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <td align="center" bgcolor="gainsboro" width="10%"></td>
                                                            <td bgcolor="gainsboro" width="15%"><b>No. Pembelian</b></td>
												...
												<tbody>
												<?php 
													$sql = mysqli_query($koneksi,"SELECT * FROM tblhutang_detail 
                                                                                WHERE 
                                                                                no_transaksi='$nobyr'");
													while ($tampil = mysqli_fetch_array($sql)) {
                                                        $no_pembelian=$tampil['no_pembelian'];
                                                        $sudah_bayar=$tampil['jumlah_bayar'];
                                                        
                                                        $cari_kd=mysqli_query($koneksi,"SELECT 
                                                                                        tanggal, total_akhir, pembayaran 
                                                        ...
                                                        <td class="center">
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-default">
                                                                    <li>
                                                                        <a href="edit_bayar_hutang.php?
                                                                        nobyr=<?php echo $tampil['no_transaksi']; ?>&nobl=<?php echo $tampil['no_pembelian']; ?>&jml=<?php echo $kekurangan; ?>">Edit Jumlah Bayar</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="hapus_bayar_hutang.php?
                                                                        nobyr=<?php echo $tampil['no_transaksi']; ?>
                                                                        &nobl=<?php echo $tampil['$no_pembelian']; ?>">Hapus Faktur Pembelian</a>
                                                                    </li>
                                                                </ul>
                                                            </div><!-- /.btn-group -->                                                                                                                
                                                        </td>
