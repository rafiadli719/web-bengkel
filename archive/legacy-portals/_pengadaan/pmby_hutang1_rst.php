<?php
    ...
    // --------------------
        ...
        if($txtflt=='asc') {
            $sql_query=" SELECT * FROM view_pembelian_header order by ".$sql_urut." asc";
        } else {
            $sql_query=" SELECT * FROM view_pembelian_header order by ".$sql_urut." desc";
        }
											...
											<form class="form-horizontal" action="" method="post">	
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, cari FROM tbcari where tipe='1' and id<'3' order by id asc");
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="center" width="10%">No. Transaksi</th>
                                            <th class="center" width="10%">Status</th>
                                            <th class="center" width="10%">Tanggal JT</th>
                                                        ...
                                                        <td width="10%" class="center">													
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-default">
                                                                    <li>
                                                                        <a href="pmby_hutang_add.php?snotrx=<?php echo $tampil['notransaksi']; ?>">Input Pembayaran</a>
                                                                    </li>
                                                                </ul>
                                                            </div><!-- /.btn-group -->
                                                        </td>
														<td class="center"><?php echo $tampil['notransaksi']?></td>														
														<td class="center"><?php echo $tampil['status']?></td>														                                                        
														<td class="center"><?php echo $tampil['tanggal_jt']?></td>
