                        ...
                        <form class="form-horizontal" action="" method="post" role="form">                                            
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-7">
                                    <?php include "_template/_servis_byr_cetak_header.php"; ?>                            
                                </div>
                                <div class="col-xs-12 col-sm-5">
                                    <?php include "_template/_servis_byr_cetak_header_kanan.php"; ?>                            
                                </div>    
                            </div>
                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-sm-4">                     		                                   
                                                    <a target="_blank"  href="servis-reguler-struk.php?snoserv=<?php echo $no_service; ?>">                            
