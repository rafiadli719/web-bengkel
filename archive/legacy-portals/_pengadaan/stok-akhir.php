											...
											<form class="form-horizontal" action="" method="post">	
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														...
														<?php
															$sql="SELECT id, cari FROM tbcari where tipe='8' order by id asc";
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														...
														<?php
															$sql="SELECT id, urut FROM tburut where tipe='8' order by id asc";
															$sql_row=mysqli_query($koneksi,$sql);
															while($sql_res=mysqli_fetch_assoc($sql_row))	
															{
														?>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="center" width="10%">Stok</td>
                                            <td class="center" width="10%">Satuan</td>
                                            <td class="center" width="10%">Rak</td>
                                            <td align="right" width="10%">Harga Pokok</td> 
