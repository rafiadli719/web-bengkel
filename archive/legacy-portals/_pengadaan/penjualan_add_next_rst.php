			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
							...
							<div class="col-xs-12 col-sm-12">
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">	
                                            <div class="row">
                                                <form class="form-horizontal" action="cari_item_penjualan_jl.php" method="post" role="form">                                            
                        ...
                        <form class="form-horizontal" action="save_penjualan.php" method="post" role="form">
