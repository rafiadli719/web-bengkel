										...
										<div class="widget-main">	
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-5">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            ...
                                                            value="<?php echo $nobl; ?>" readonly="true" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                ...
                                                                value="<?php echo $tgl_pilih; ?>" disabled data-date-format="dd/mm/yyyy" />
                                                ...
                                                <div class="col-xs-12 col-sm-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tanggal Pesan :</label>									
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                <input class="form-control date-picker" id="id-date-picker-2" name="id-date-picker-2" type="text" autocomplete="off" 
                                                                value="<?php echo $tgl_order; ?>" disabled data-date-format="dd/mm/yyyy" />
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-calendar bigger-110"></i>
                                                                </span>
                                                            </div>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_pembelian_cetak.php"; ?>
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            value="<?php echo $syarat; ?> Hari" disabled />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6">
