				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="cabang.php">Master Cabang</a>
							</li>                                                                                    
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" action="cabang_edit_proses.php" method="post">
									<input type="hidden" name="txtid"  class="form-control" value="<?php echo $kdcabang; ?>"/>

									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Kode Cabang </label>
										<div class="col-sm-9">
											<input type="text" value="<?php echo $kdcabang; ?>" disabled />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<option value="">- Pilih -</option>
												<?php
												$q = mysqli_query($koneksi,"select id, cabang_tipe FROM tbcabang_tipe");
												while ($row1 = mysqli_fetch_array($q)){
													$k_id           = $row1['id'];
													$k_opis         = $row1['cabang_tipe'];
											?>
											<option value='<?php echo $k_id; ?>' <?php if ($k_id == $tipe_cabang){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
											<?php
												}
											?>
											</select>
