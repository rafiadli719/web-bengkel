<?php
    ...
    // --------------------
		...
		$no_polisi=$_GET['snopol'];
		$kode_pelanggan=$no_polisi;        
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <form class="form-horizontal" action="save_antar_jemput.php" method="post" role="form">                                            
                            <input type="hidden" name="txtnopol" 
                            class="form-control" value="<?php echo $no_polisi; ?>"/>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <table id="dynamic-table" class="table table-bordered">
                                        ...
                                        <tr>
                                            <td width="18%"><font size="2"><b>Alamat</b></font></td>
                                            <td width="2%" align="center"><font size="2"><b>:</b></font></td>
                                            <td width="30%" bgcolor="<?php echo $baris_bgcolor; ?>"><font size="2"><?php echo $alamat; ?></font></td>
                                            ...
                                            <div class="widget-main">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-8 col-sm-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-8 col-sm-12">
                                                                <textarea class="col-xs-10 col-sm-12" id="txtket" name="txtket" rows="3"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8 col-sm-3">
                                    ...
                                    onclick="return confirm('Keluan dari form. Lanjutkan?')">                                                                    
