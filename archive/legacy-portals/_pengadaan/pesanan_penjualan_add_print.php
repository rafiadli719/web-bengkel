				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td width="20%" bgcolor="beige">Sales</td>
                                        <td width="30%"><?php echo $namasales; ?></td>
                                        <td width="20%" bgcolor="beige"></td>
                                        <td width="30%"></td>
                                    </tr>                                    
                                </table>    
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td align="right" width="15%">Harga</td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td align="right"><?php echo $tot_order; ?></td>
                                            <td align="right" colspan="2" bgcolor="gainsboro">Sub Total:</td>
                                            <td align="right"><?php echo number_format($total_beli,0)?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right"><?php echo number_format($total_pajak,0)?></td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="row">
							...
							<div class="col-xs-12 col-sm-2">
                                <a target="_blank"  href="pesanan_penjualan_struk.php?snobl=<?php echo $nobl; ?>">                            
