<?php
	...
	if(empty($_SESSION['_iduser'])){
        ...
        $total_service="0";
        $total_barang="0";
        $total_keseluruhan=$total_service+$total_barang;
        
		if(isset($_POST['btncari'])) {				
			$txtcaribrg= $_POST['txtcaribrg'];	
			$txtnoplg= $_POST['txtnoplg'];	
            $txtkm_skr= $_POST['txtkm_skr'];
            $cbo_mekanik1= $_POST['cbomekanik1'];
        ...
        if(isset($_POST['btnadd'])) {	
            ...
            if($txtkdbarang<>'') {
                mysqli_query($koneksi,"INSERT INTO tblservis_barang 
                                        ...
                                        potongan, total) 
                                        VALUES 
                                        ('$LastID', '$txtkdbarang','$txthargabarang','$txtqty',
                                        '$txtpot','$subtotal')");
        ...
        if(isset($_POST['btnaddsrv'])) {	
            ...
            $cari_kd=mysqli_query($koneksi,"SELECT harga, waktu FROM tblitem_jasa WHERE noitem='$txtkdsrv'");			
            $tm_cari=mysqli_fetch_array($cari_kd);
            ...
            if($txtkdsrv<>'') {
                mysqli_query($koneksi,"INSERT INTO tblservis_jasa 
                                        ...
                                        potongan, total) 
                                        VALUES 
                                        ('$LastID', '$txtkdsrv','$txthargasrv','$waktu',
                                        '$txtpotsrv','$subtotal')");
					...
					<div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-8">
                                <?php include "_template/_servis_header1.php"; ?>                            
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                <?php include "_template/_servis_header2.php"; ?>                            
                            </div>    
                        </div>
