						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-header">
									<a href="kas_keluar_add.php"><font color="white">[ Tambah ]</font></a>
								</div>
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<?php 
													$no = 0 ;
													$sql = mysqli_query($koneksi,"SELECT *, DATE_FORMAT(tanggal,'%d/%m/%Y') AS tanggal_trx 
													...
													<tr>
														...
														<td class="center">													
															<a class="green" data-rel="tooltip" title="Edit" 
																href="kas_keluar_edit.php?kd=<?php echo $tampil['kode_km']?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>&nbsp;
															<a class="red" data-rel="tooltip" title="Delete" 
																href="kas_keluar_del.php?kd=<?php echo $tampil['kode_km']?>" 
																onclick="return confirm('Data Kas Keluar akan dihapus. Lanjutkan?')">
