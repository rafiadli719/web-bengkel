<?php
    ...
    // --------------------
        ...
        if(isset($_POST['btnadd'])) {	
            ...
            if($txtkdbarang<>'') {
                $data = mysqli_query($koneksi,"SELECT * FROM tbitem_keluar_detail 
                                                WHERE 
                ...
                if($cek > 0){
                    ...
                    window.location=('stok_keluar_add_rst.php?stgl=$tgl_pilih&kd=$kdbrg');</script>";			            
                } else {    
                    // cek stok disini
                    // jika kurang atau =0                    
                    // tolak
            ...
            // insert ke order header                
                ...
                // ------ Stok ----------
                    ...
                    while ($tampil = mysqli_fetch_array($sql)) {
                        ...
                        echo"<script>window.location=('stok_keluar_add_cetak.php?nopesanan=$LastID');</script>";                            
                    }                
            }
        }             
?>
