<?php
    ...
    // --------------------
		...
		$drcabang=$tm_cari['no_supplier'];
        $total_qty=$tm_cari['total_qty'];
        $note=$tm_cari['note'];
        $no_penjualan=$tm_cari['no_penjualan']; 
        
        // Total Order
        $total_order=$tm_cari['total_order'];
        
        // Mencari potongan, pajak, dll di tabel penjualan_header
		$cari_kd=mysqli_query($koneksi,"SELECT 
                                        carabayar, 
                                        total_jual, diskon, total_diskon, 
                                        pajak, total_pajak, 
                                        total_akhir, pembayaran, jumlah_bayar 
                                        FROM tblpenjualan_header 
                                        WHERE notransaksi='$no_penjualan'");
		$tm_cari=mysqli_fetch_array($cari_kd);	
		...
		$kekurangan=$tm_cari['jumlah_bayar'];       
            ...
            // Stok Barang
                ...
                while ($tampil = mysqli_fetch_array($sql)) {
                    ...
                    mysqli_query($koneksi,"INSERT INTO tbstok 
                                        ...
                                        ('2','$LastID','$no_item',
                                        '$txttgljl','$qty','0',
                                        'Pembelian Antar Cabang','$kd_cabang')"); 
                }
            // ----- End -----         
                        
            mysqli_query($koneksi,"UPDATE tblorder_header 
                                    SET 
                                    status='1', status_pesanan='1' 
                                    WHERE no_order='$nopesanan'");                                                            

            echo"<script>window.alert('Proses Penerimaan ke Pembelian telah berhasil!');
            window.location=('pembelian_cab_add.php');</script>";
        }        
?>
...
<?php include "menu_antarcab03.php"; ?>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="#">Antar Cabang</a>
							</li>                            
							<li class="active">Penerimaan (Proses Ke Pembelian)</li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
                        ...
                        <input type="hidden" name="txttotal_harga"  class="form-control" value="<?php echo $netto; ?>"/>
						<div class="row">
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">	
                                            <br>
                                            <?php include "_template/_tarik_data_pesananbl_header.php"; ?>
										</div>
									</div>
								</div>	
							</div>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_tarik_data_pesananbl_detail.php"; ?>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_tarik_data_pesananbl_lainnya.php"; ?>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_tarik_data_pesananbl_total.php"; ?>
