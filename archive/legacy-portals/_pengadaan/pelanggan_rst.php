<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {				
			...
			echo"<script>window.location=('pelanggan_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
			echo"<script>window.location=('pelanggan_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";            
        }
?>
                        ...
                        <div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="table-header">
									<a href="pelanggan_add.php"><font color="white">[ Tambah Pelanggan ]</font></a>
								</div>                            
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pelanggan_edit.php?kd=<?php echo $tampil['nopelanggan']?>">Edit Pelanggan</a>
                                                        </li>
                                                        <li>
                                                            <a href="pelanggan_del.php?kd=<?php echo $tampil['nopelanggan']?>" 
                                                            onclick="return confirm('Data Pelanggan akan dihapus. Lanjutkan?')">Hapus</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a href="pelanggan_awal_piutang.php?kd=<?php echo $tampil['nopelanggan']?>">Saldo Awal Piutang																
                                                            </a>
                                                        </li>                                                        
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
