						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-header">
									<a href="kendaraan_add.php"><font color="white">[ Tambah ]</font></a>
								</div>
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th width="20%" class="center">Warna</th>                                                        
												...
												<?php 
													$no = 0 ;
													$sql = mysqli_query($koneksi,"SELECT * FROM tblkendaraan");
													while ($tampil = mysqli_fetch_array($sql)) {
														$no++;
                                                        $kode_merek=$tampil['kode_merek'];
													...
													<tr>
														...
														<td class="center">													
															<a class="green" data-rel="tooltip" title="Edit" 
																href="kendaraan_edit.php?kd=<?php echo $tampil['nopolisi']?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>&nbsp;
															<a class="red" data-rel="tooltip" title="Delete" 
																href="kendaraan_del.php?kd=<?php echo $tampil['nopolisi']?>" 
																onclick="return confirm('Data Kendaraan akan dihapus. Lanjutkan?')">
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('#simple-table').css({'width':'2000px'clTabCtrl, 'max-width': 'none'}).wrap('<div style="width: 1000px;" />').parent().ace_scroll(
				  {
					horizontal: true,
