...
DATE_FORMAT(tanggal,'%d/%m/%Y') AS tanggal_trx, note 
        ...
        $sisa_bayar=$total_akhir-$pembayaran;        
                        ...
                        <div class="row">
							<div class="col-xs-12 col-sm-12">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            <td colspan="3" bgcolor="gainsboro" align="right">Total Qty : </td>
                                        ...
                                        <td colspan="4" align="right"></td>
                                            ...
                                            <td align="right" bgcolor="red">
                                                <font color="white"><?php echo number_format($sisa_bayar,0)?></font>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
