<?php
    ...
    // --------------------
        ...
        $cari_kd=mysqli_query($koneksi,"SELECT 
                                        kode_barang,jumlah, harga, total 
                                        FROM tbworkorderdetail 
                                        WHERE id='$sid'");			
        $tm_cari=mysqli_fetch_array($cari_kd);
        $no_item=$tm_cari['kode_barang'];
        $qty=$tm_cari['jumlah'];
        $harga=$tm_cari['harga'];
        $total=$tm_cari['total'];
        ...
        if(isset($_POST['btnsimpan'])) {
            ...
            mysqli_query($koneksi,"UPDATE 
                                    ...
                                    SET 
                                    jumlah='$txtqty', 
                                    harga='$txtharga', total='$subtotal' 
                                    WHERE 
                                    id='$sid'");                                         
            $kdbrg="";
            $kdjasa="";
            echo"<script>window.location=('paket_add_rst.php?snamawo=$txtnamawo&sketwo=$txtketwo&kd=$kdbrg&kdjasa=$kdjasa&swaktu=$swaktu');</script>";			            
        }
