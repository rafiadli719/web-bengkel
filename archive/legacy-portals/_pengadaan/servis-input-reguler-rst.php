<?php
    ...
    // --------------------
		...
		if(isset($_POST['btnaddkeluhan'])) {				
            ...
            echo"<script>window.location=('servis-input-reguler-rst.php?snoserv=$no_service&kd=$txtcaribrg&kdjasa=$txtcarisrv');
            </script>";
        }        
		...
		if(isset($_POST['btncarisrv'])) {	
            ...
            //if($tot_cari=='0') { 
              ...
              //  echo"<script>window.alert('Item Service tidak ditemukan!');
               // window.location=('servis-input-reguler-rst.php?snoserv=$no_service');
               // </script>";        
            //} else {
                if($tot_cari=='1') {
                    $cari_kd=mysqli_query($koneksi,"SELECT nama_wo 
