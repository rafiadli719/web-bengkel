		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<br>
					<form class="form-horizontal" enctype="multipart/form-data" action="profile_proses.php" method="post">
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
											<center><img id="avatar" src="../<?php echo $foto_user; ?>" width="100" height="100" /></center>
											<br>
											<label>
												<span class="lbl"> Change/Upload Foto</span>
											</label>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="form-group">
												<div class="col-xs-12">
													<input type="text" class="col-xs-10 col-sm-12" disabled value="<?php echo $id_user; ?>" />
												</div>
											</div>
											<br>
											<label>
											...
											<div class="form-group">
												<div class="col-xs-12">
													<input type="text" id="txtuser" name="txtuser" class="col-xs-10 col-sm-12" 
													value="<?php echo $_nama; ?>" autocomplete="off" />
												</div>
											</div>
											<br>&nbsp;<br>
											<div class="form-group">
