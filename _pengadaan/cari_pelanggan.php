<?php
    ...
    // --------------------
		...
		if(isset($_POST['btnasc'])) {				
			...
			echo"<script>window.location=('cari_pelanggan_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
			echo"<script>window.location=('cari_pelanggan_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";            
        }
?>
											...
											<form class="form-horizontal" action="" method="post">	
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														...
														<?php
															$sql="SELECT id, cari FROM tbcari where tipe='5' order by id asc";
															$sql_row=mysqli_query($koneksi,$sql);
															while($sql_res=mysqli_fetch_assoc($sql_row))	
															{
														?>
														<option value="<?php echo $sql_res["id"]; ?>"><?php echo $sql_res["cari"]; ?></option>
														<?php
															}
														?>
														</select>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														...
														<?php
															$sql="SELECT id, urut FROM tburut where tipe='5' order by id asc";
															$sql_row=mysqli_query($koneksi,$sql);
															while($sql_res=mysqli_fetch_assoc($sql_row))	
															{
														?>
														<option value="<?php echo $sql_res["id"]; ?>"><?php echo $sql_res["urut"]; ?></option>
														<?php
															}
														?>
														</select>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="center" width="10%">Propinsi</td>
                                            <td class="center" width="10%">No. Telepon</td>
                                            <td class="center" width="10%">Kontak Person</td>
                                            <td class="center" width="10%">Grup Pelanggan</td>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
