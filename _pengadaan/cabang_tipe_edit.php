<?php
    ...
    // --------------------        
		...
		$kd=$_GET['kd'];
		$cari_kd=mysqli_query($koneksi,"SELECT 
										cabang_tipe FROM tbcabang_tipe 
										WHERE 
										id='$kd'");
		$tm_cari=mysqli_fetch_array($cari_kd);	
		$jenis=$tm_cari['cabang_tipe'];
?>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="cabang_tipe.php">Tipe Cabang</a>
							</li>                                                                                    
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" action="cabang_tipe_edit_proses.php" method="post">
