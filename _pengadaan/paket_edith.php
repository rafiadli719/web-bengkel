...
<?php include "menu_master01h.php"; ?>
			...
			<div class="main-content">
				<div class="main-content-inner">
                    ...
                    <form class="form-horizontal" action="paket_edith_proses.php" method="post">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        value="<?php echo $no_wo; ?>" disabled />
                                        <input type="hidden" class="col-xs-10 col-sm-6" 
                                        value="<?php echo $no_wo; ?>" 
                                        id="txtkode" name="txtkode" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        value="<?php echo $nama_wo; ?>" autocomplete="off" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-6 control-label no-padding-right" for="form-field-1"> Harga Paket </label>
                                    <div class="col-sm-5">
                                        <input type="text" id="txtharga" name="txtharga" class="col-xs-10 col-sm-12" 
                                        value="<?php echo $txtharga; ?>" autocomplete="off" />
                                    </div>
                                </div>    
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="col-xs-10 col-sm-12" id="txtnote" name="txtnote" rows="8"><?php echo $ket_wo; ?></textarea>
                                    </div>
                                </div>    
                            </div> 
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <a href="paket.php" 
                                onclick="return confirm('Edit Work Order Header akan dibatalkan. Lanjutkan?')">                                                                    
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right"><?php echo $tampil['jumlah']?></td>														                                                                                                                
                                                    ...
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                                                <td class="center" width="5%">No</td>
                                                                <td width="25%">Kode</td>
                                                                <td width="40%">Nama Barang/Part</td>
                                                                <td align="right" width="10%">Jumlah</td>
                                                                <td align="right" width="10%">Harga</td>
                                                                <td align="right" width="10%">Total</td>                                                                
                                                            </tr>
