                                                            ...
                                                            <table width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        <div class="col-xs-8 col-sm-12">
                                                                            ...
                                                                            class="form-control" value="<?php echo number_format($net,0)?>"/>
                                                                        </div>                                                                    
                                                                    </td>
                                                                </tr>                                                                
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        <div class="col-xs-8 col-sm-12">
                                                                            <input type="text" class="form-control" 
                                                                            id="txtkembalian1" name="txtkembalian1" 
                                                                            value="<?php echo number_format($kembalian,0)?>" disabled />

                                                                            <input type="hidden" id="txtkembalian" name="txtkembalian" 
                                                                            class="form-control" value="<?php echo $kembalian; ?>"/>  
                                                                        </div>                                                                    
                                                                    </td>
                                                                </tr>                                                                                                                                                                                                                                                         
                                                            </table>														                                                            
