											...
											<div class="widget-box">
												<div class="widget-body">
													<div class="widget-main">
                                                        ...
                                                        <div class="row">
															<div class="col-xs-8 col-sm-12">
                                                                <h4 class="header green">Jemput Antar</h4>
                                                            </div>
															<div class="col-xs-8 col-sm-6">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xs-8 col-sm-12">
                                                                        <input type="text" class="form-control" 
                                                                        value="<?php echo $tanggal; ?>" readonly="true" />
                                                                    </div>
                                                                </div>
                                                            </div>
															<div class="col-xs-8 col-sm-6">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xs-8 col-sm-12">
                                                                        <input type="text" class="form-control" 
                                                                        value="<?php echo $jam; ?>" readonly="true" />
                                                                    </div>
                                                                </div>
                                                            </div>
															...
															<div class="col-xs-8 col-sm-12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xs-8 col-sm-12">
                                                                        <input type="text" class="form-control" 
                                                                        value="<?php echo $alamat; ?>" readonly="true" />
                                                                    </div>
                                                                </div>
                                                            </div>
															<div class="col-xs-8 col-sm-12">&nbsp;</div>
															<div class="col-xs-8 col-sm-12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xs-8 col-sm-12">
                                                                        <input type="text" class="form-control" 
                                                                        value="<?php echo $patokan; ?>" readonly="true" />
                                                                    </div>
                                                                </div>
                                                            </div>
															<div class="col-xs-8 col-sm-12">&nbsp;</div>
															<div class="col-xs-8 col-sm-12">
                                                                <a target="_blank" href="sp-ambil-motor.php?snosrv=<?php echo $no_service; ?>">                            
                                                                <button type="button" class="btn btn-warning btn-block">
                                                                    <i class="ace-icon fa fa-print icon-on-right bigger-110"></i>
                                                                    Cetak Surat Perintah Pengambilan Motor
                                                                </button>                            
                                                                </a>                                                            
                                                            </div>
                                                        </div>
