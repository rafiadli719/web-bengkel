...
$nopesanan= $_POST['txtnopesanan'];
            ...
            if($tot_cari=='1') {
                ...
                $cbocari="";
                $cbourut="35";
                echo"<script>window.location=('pembelian_add_item_cari.php?stgl=$tgl_pilih&ssup=$cbo_supplier&spesan=$nopesanan&_key=$txtcaribrg&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
            }
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-5">
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label no-padding-right" for="txtnopesanan"> No. Transaksi :</label>									
                                                        <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> No. Pesanan :</label>									
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
