			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						<br>
                        <form class="form-horizontal" action="save_barang.php" method="post">
						<div class="row">
							<div class="col-xs-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                        ?>
                                                        <option value="<?php echo $sql_res["id"]; ?>"><?php echo $sql_res["rak_barang"]; ?></option>
                                                        <?php
                                                            }
                                                        ?>
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                        ?>
                                                        <option value="<?php echo $sql_res["kode_cabang"]; ?>"><?php echo $sql_res["kode_cabang"]; ?> - <?php echo $sql_res["nama_cabang"]; ?></option>
                                                        <?php
                                                            }
                                                        ?>
                                                        </select>
