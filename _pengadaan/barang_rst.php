											...
											<form class="form-horizontal" action="" method="post">	
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, cari FROM tbcari where tipe='8' order by id asc");
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, urut FROM tburut where tipe='8' order by id asc");
                                                            while ($row1 = mysqli_fetch_array($q)){
                                                                $k_id           = $row1['id'];
                                                                $k_opis         = $row1['urut'];
                                                        ?>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<button class="btn <?php echo $tipebtn1; ?>" type="submit" id="btnasc" name="btnasc">
															<i class="ace-icon fa fa-arrow-up icon-on-right"></i> Ascending
														</button>							
														<button class="btn <?php echo $tipebtn2; ?>" type="submit" id="btndesc" name="btndesc">
                        ...
                        <div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="table-header">
									<a href="barang_add.php"><font color="white">[ Tambah Item ]</font></a>
								</div>                            
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            while ($tampil = mysqli_fetch_array($sql)) {
                                                ...
                                                $stok_awal=$tampil['inv_jmlawal'];
                                                $stok_min=$tampil['stokmin'];
                                                ...
                                                if($stok_akhir=='0') {
                                                    $rows_bgcolor="red";
                                                    $rows_fontcolor="white";
                                                } else {
                                                    if($stok_akhir<=$stok_min) {
                                                        $rows_bgcolor="yellow";
                                                        $rows_fontcolor="black";                                                                                                                  
                                                    } else {
                                                        $rows_bgcolor="white";
                                                        $rows_fontcolor="black";                                                          
                                                    }                                                                                                      
                                            ...
                                            <td class="center" >
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="barang_edit.php?kd=<?php echo $tampil['noitem']?>">Edit Item</a>
                                                        </li>
                                                        <li>
                                                            <a href="barang_del.php?kd=<?php echo $tampil['noitem']?>" 
                                                            onclick="return confirm('Data Barang akan dihapus. Lanjutkan?')">Hapus</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a target="_blank" href="barang_stok_akhir.php?kd=<?php echo $tampil['noitem']?>">Stok Akhir</a>
                                                        </li>
                                                        <li>
                                                            <a target="_blank" href="barang_kartu_stok.php?kd=<?php echo $tampil['noitem']?>">Kartu Stok</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a target="_blank" href="barang_history_hp.php?kd=<?php echo $tampil['noitem']?>">History Harga Pokok</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>														
                                            <td bgcolor="<?php echo $rows_bgcolor; ?>"><font color="<?php echo $rows_fontcolor; ?>"><?php echo $tampil['noitem']?></font></td>														
                                            <td bgcolor="<?php echo $rows_bgcolor; ?>"><font color="<?php echo $rows_fontcolor; ?>"><?php echo $tampil['kodebarcode']?></font></td>														                                                        
                                            <td bgcolor="<?php echo $rows_bgcolor; ?>"><font color="<?php echo $rows_fontcolor; ?>"><?php echo $tampil['namaitem']?></font></td>														                                                                                                                
                                            <td bgcolor="<?php echo $rows_bgcolor; ?>" class="center"><font color="<?php echo $rows_fontcolor; ?>"><?php echo $tampil['namajenis']?></font></td>														                                                                                                                
                                            <td bgcolor="<?php echo $rows_bgcolor; ?>" align="right"><font color="<?php echo $rows_fontcolor; ?>"><?php echo $stok_akhir; ?></font></td>														                                                                                                                                                                        
                                            <td bgcolor="<?php echo $rows_bgcolor; ?>" align="right"><font color="<?php echo $rows_fontcolor; ?>"><?php echo $tampil['stokmin']?></font></td>
                                            <td bgcolor="<?php echo $rows_bgcolor; ?>" class="center"><font color="<?php echo $rows_fontcolor; ?>"><?php echo $tampil['satuan']?></font></td>														
                                            <td bgcolor="<?php echo $rows_bgcolor; ?>" class="center"><font color="<?php echo $rows_fontcolor; ?>"><?php echo $tampil['rakbarang']?></font></td>														                                                        
                                            <td bgcolor="<?php echo $rows_bgcolor; ?>" align="right"><font color="<?php echo $rows_fontcolor; ?>"><?php echo number_format($tampil['hargapokok'],0)?></font></td>														                                                        
                                            <td bgcolor="<?php echo $rows_bgcolor; ?>" align="right"><font color="<?php echo $rows_fontcolor; ?>"><?php echo number_format($tampil['hargajual'],0)?></font></td>														                                                                                                                
