<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {				
			...
			echo"<script>window.location=('penyesuaian-stok-keluar-manual-rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
			echo"<script>window.location=('penyesuaian-stok-keluar-manual-rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";            
        }
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <form class="form-horizontal" action="" method="post" role="form">
                                                <?php include "_template/_penyesuaian_stok_cari.php"; ?>
                                            </form>
                                        </div>
									</div>
								</div>	
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a target="_blank" href="stok_keluar_detail.php?nopesanan=<?php echo $tampil['no_transaksi']; ?>">Detail Transaksi</a>
                                                        </li>
                                                        <li>
                                                            <a target="_blank" href="stok_keluar_struk.php?snopesanan=<?php echo $tampil['no_transaksi']; ?>">Cetak Nota</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>														
