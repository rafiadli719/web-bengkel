<?php
    ...
    $nama_file="Laporan Pembayaran Piutang ".$tgl_pilih_dari." s/d ".$tgl_pilih_sampai.".xls";
?>
...
<body>
	...
	?>
										...
										<b>
										<h4>
										Laporan Pembayaran Piutang<br> Periode <?php echo $tgl_pilih_dari; ?>&nbsp;s/d&nbsp;<?php echo $tgl_pilih_sampai; ?>
										</h4>
										</b> 
