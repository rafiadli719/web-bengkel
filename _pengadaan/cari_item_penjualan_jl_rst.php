<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {				
			...
			echo"<script>window.location=('cari_item_penjualan_jl_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc&_nopesan=$txtnoorder');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbourut= $_POST['cbourut'];
            $txtnoorder= $_POST['txtnoorder'];
			echo"<script>window.location=('cari_item_penjualan_jl_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc&_nopesan=$txtnoorder');</script>";            
        }
?>
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="penjualan_add_next_rst.php?kd=<?php echo $tampil['noitem']; ?>&noorder=<?php echo $txtnoorder; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>														
