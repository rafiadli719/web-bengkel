						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-header">
									<a href="pelanggan_add.php"><font color="white">[ Tambah ]</font></a>
								</div>
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<?php 
													...
													while ($tampil = mysqli_fetch_array($sql)) {
														$no++;
                                                        $kgrup=$tampil['kgrup'];
		$cari_kd=mysqli_query($koneksi,"SELECT grup FROM tblpelanggangrup 
                                        WHERE kgrup='$kgrup'");			
		$tm_cari=mysqli_fetch_array($cari_kd);
		$grup=$tm_cari['grup'];				                                                                
												?>
													<tr>
														...
														<td class="center"><?php echo $grup; ?></td>
														<td class="center">													
															<a class="green" data-rel="tooltip" title="Edit" 
																href="pelanggan_edit.php?kd=<?php echo $tampil['nopelanggan']?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>&nbsp;
															<a class="red" data-rel="tooltip" title="Delete" 
																href="pelanggan_del.php?kd=<?php echo $tampil['nopelanggan']?>" 
																onclick="return confirm('Data Pelanggan akan dihapus. Lanjutkan?')">
