<?php
    ...
    // --------------------				        
		...
		if(isset($_POST['btnaddkeluhan'])) {				
            ...
            mysqli_query($koneksi,"INSERT INTO tbservis_keluhan 
                            (no_service, keluhan) 
                            VALUES 
                            ('$no_service','$txtkeluhan')");  

            echo"<script>window.location=('servis-garansi.php?snoserv=$no_service&kd=$txtcaribrg&kdjasa=$txtcarisrv');
            </script>";
        }        
        ...
        if(isset($_POST['btnaddsrv'])) {	
            ...
            $cari_kd=mysqli_query($koneksi,"SELECT 
                                            sum(subtotal) as harga_paket 
                                            FROM 
                                            view_wo_harga 
                                            WHERE 
                                            kode_wo='$txtkdsrv'");			
            $tm_cari=mysqli_fetch_array($cari_kd);
            $txthargasrv=$tm_cari['harga_paket'];        
            //$waktu=$tm_cari['waktu'];        
            $waktu="0";
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Servis Garansi</li>
						</ul><!-- /.breadcrumb -->
					</div>
                        ...
                        <form class="form-horizontal" action="" method="post" role="form">                                            
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-7">
                                    <?php include "_template/_servis_garansi_header.php"; ?>                            
                                </div>
                                <div class="col-xs-12 col-sm-5">
                                    <?php include "_template/_servis_garansi_header_kanan.php"; ?>                            
                                </div>    
                            </div>
