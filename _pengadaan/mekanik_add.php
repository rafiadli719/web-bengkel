			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" action="save_mekanik.php" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php
												$sql="select id, mekanik_level FROM tbmekanik_level";
												$sql_row=mysqli_query($koneksi,$sql);
												while($sql_res=mysqli_fetch_assoc($sql_row))	
												{
											?>
											<option value="<?php echo $sql_res["id"]; ?>"><?php echo $sql_res["mekanik_level"]; ?></option>
											<?php
												}
											?>
											</select>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            <textarea class="col-xs-10 col-sm-6" id="txtnote" name="txtnote" rows="2"></textarea>
										</div>
									</div>
