...
out_file = r"C:\xampp\htdocs\web-bengkel\aplikasi\aplikasi\excel_reconstructed_sheet24.txt"
...
if os.path.exists(sheet_file):
    ...
    try:
        ...
        with open(out_file, "w", encoding="utf-8") as f:
            f.write(f"RECONSTRUCTED EXCEL CONTENT FROM SHEET24 (RENCANA ORDER)\n")
                    ...
                    for c in elem.findall(f'{{{ns}}}c'):
                        ...
                        if v_elem is not None:
                            if cell_type == 's':
                                ...
                                value = v_elem.text if v_elem.text else ""
