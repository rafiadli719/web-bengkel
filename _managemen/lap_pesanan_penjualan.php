<?php
    ...
    // ---- SQL Detail -----
        $sql_query="SELECT *, DATE_FORMAT(tanggal,'%d/%m/%Y') AS tanggal_trx 
                            ...
                            tanggal<='$tgl_pilih_sampai_eng') AND 
                            kd_cabang='$cbo_cabang' 
    ...
    // ---- SQL Total Data -----                            
		...
		if(isset($_POST['btnpdf'])) {				
			...
			echo"<script>window.location=('lap_pesanan_penjualan_pdf.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai&ssup=$nopelanggan');</script>";                        
        }        
		if(isset($_POST['btnxl'])) {				
            $tgl_pilih_dari= $_POST['id-date-picker-1'];
            $tgl_pilih_sampai= $_POST['id-date-picker-2'];            
            $nopelanggan= $_POST['txtpelanggan'];
			echo"<script>window.location=('lap_pesanan_penjualan_xls.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai&ssup=$nopelanggan');</script>";                        
        }        
?>
...
<?php include "menu_laporan04.php"; ?>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Pesanan Penjualan</li>
						</ul><!-- /.breadcrumb -->
					</div>
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <form class="form-horizontal" action="" method="post" role="form">
                                                <?php include "_template/_lap_pesanan_pembelian_header.php"; ?>
                                            </form>
                                        </div>
									</div>
								</div>	
                        ...
                        <div class="row">
							<div class="col-xs-12 col-sm-12">
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <td bgcolor="gainsboro" class="center" width="10%"><b>No. Pesanan</b></td>
                                            <td bgcolor="gainsboro" class="center" width="9%"><b>Tanggal</b></td>
                                            ...
                                            <td bgcolor="gainsboro" width="8%" align="right"><b>Total Qty</b></td>
                                            <td bgcolor="gainsboro" width="9%" align="right"><b>Total Order</b></td>
                                            <td bgcolor="gainsboro" width="8%" align="right"><b>Diskon</b></td>
                                            <td bgcolor="gainsboro" width="8%" align="right"><b>Pajak</b></td>
                                            <td bgcolor="gainsboro" width="9%" align="right"><b>Total Akhir</b></td>
                                            <td bgcolor="gainsboro" width="10%"><b>Cabang</b></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php 
...
$kd_cabang_trx=$tampil['kd_cabang'];
                                            
                                            $cari_kd=mysqli_query($koneksi,"SELECT 
                                        nama_cabang FROM tbcabang 
                                        WHERE kode_cabang='$kd_cabang_trx'");			
                                            $tm_cari=mysqli_fetch_array($cari_kd);
                                            $nama_cabang_trx=$tm_cari['nama_cabang'];                                            
                                    ...
                                    ?>
                                        <tr>
                                            <td class="center"><?php echo $tampil['no_order']?></td>														
														...
														<td><?php echo $tampil['namasales']?></td>														                                                        										                                                        
														<td align="right"><?php echo $tampil['total_qty']?></td>														                                                                                                                
                                                        <td align="right"><?php echo number_format($tampil['total_jual'],0)?></td>
                                                        <td align="right"><?php echo number_format($tampil['diskon'],0)?></td>
                                                        <td align="right"><?php echo number_format($tampil['pajak'],0)?></td>
														<td align="right"><?php echo number_format($tampil['total_akhir'],0)?></td>															                                                                                                                
<td><?php echo $nama_cabang_trx; ?></td>                                        
                                        </tr>
