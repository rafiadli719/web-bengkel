<?php
    ...
    // ---- SQL Total Data -----                            
		...
		if(isset($_POST['btnpdf'])) {				
			...
			echo"<script>window.location=('lap_servis_pdf.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai&ssup=$nopelanggan');</script>";                        
        }        
		if(isset($_POST['btnxl'])) {				
            $tgl_pilih_dari= $_POST['id-date-picker-1'];
            $tgl_pilih_sampai= $_POST['id-date-picker-2'];            
            $nopelanggan= $_POST['txtpelanggan'];
			echo"<script>window.location=('lap_servis_xls.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai&ssup=$nopelanggan');</script>";                        
        }        
?>
...
<?php include "menu_laporan07.php"; ?>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td bgcolor="gainsboro" class="center" width="10%"><b>No. Service</b></td>
                                            <td bgcolor="gainsboro" class="center" width="10%"><b>Tanggal</b></td>
                                            <td bgcolor="gainsboro" width="10%"><b>No. Polisi</b></td>
                                            <td bgcolor="gainsboro" width="16%"><b>Nama Pelanggan</b></td>
