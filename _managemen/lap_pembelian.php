<?php
    ...
    // ---- SQL Total Data -----                            
		...
		if(isset($_POST['btnpdf'])) {				
			...
			echo"<script>window.location=('lap_pembelian_pdf.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai&ssup=$cbo_supplier');</script>";                        
        }        
		if(isset($_POST['btnxl'])) {				
            $tgl_pilih_dari= $_POST['id-date-picker-1'];
            $tgl_pilih_sampai= $_POST['id-date-picker-2'];            
            $cbo_supplier= $_POST['cbosupplier'];
			echo"<script>window.location=('lap_pembelian_xls.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai&ssup=$cbo_supplier');</script>";                        
        }        
?>
...
<?php include "menu_laporan02.php"; ?>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td bgcolor="gainsboro" class="center" width="9%"><b>Cara Bayar</b></td>
                                            <td bgcolor="gainsboro" class="center" width="9%"><b>No. Pesanan</b></td>
                                            <td bgcolor="gainsboro" class="center" width="9%"><b>Tgl Pesanan</b></td>                                            
                                            ...
                                            <td bgcolor="gainsboro" width="15%"><b>Cabang</b></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php 
                                        ...
                                        while ($tampil = mysqli_fetch_array($sql)) {
                                            $no++;
                                            $tot_beli=$tot_beli+$tampil['total_akhir'];
$kd_cabang_trx=$tampil['kd_cabang'];
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" bgcolor="gainsboro"><b><?php echo number_format($tot_beli,0)?></b></td>
