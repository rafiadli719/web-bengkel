...
$cbo_cabang="";
    ...
    // ---- SQL Total Data -----                            
		...
		if(isset($_POST['btnpdf'])) {				
            $tgl_pilih_dari= $_POST['id-date-picker-1'];
            $tgl_pilih_sampai= $_POST['id-date-picker-2'];            
			echo"<script>window.location=('lap_kas_masuk_pdf.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai');</script>";                        
        }        
		if(isset($_POST['btnxl'])) {				
            $tgl_pilih_dari= $_POST['id-date-picker-1'];
            $tgl_pilih_sampai= $_POST['id-date-picker-2'];            
			echo"<script>window.location=('lap_kas_masuk_xls.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai');</script>";                        
        }        
?>
...
<?php include "menu_laporan08.php"; ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $tampil['uraian']?></td>				   
														<td align="right"><?php echo number_format($tampil['masuk'],0)?></td>						
