...
$cbo_cabang="";
    ...
    // ---- SQL Total Data -----                            
		...
		if(isset($_POST['btnpdf'])) {				
            $tgl_pilih_dari= $_POST['id-date-picker-1'];
            $tgl_pilih_sampai= $_POST['id-date-picker-2'];            
			echo"<script>window.location=('lap_kas_keluar_pdf.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai');</script>";                        
        }        
		if(isset($_POST['btnxl'])) {				
            $tgl_pilih_dari= $_POST['id-date-picker-1'];
            $tgl_pilih_sampai= $_POST['id-date-picker-2'];            
			echo"<script>window.location=('lap_kas_keluar_xls.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai');</script>";                        
        }        
?>
...
<?php include "menu_laporan09.php"; ?>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td bgcolor="gainsboro" width="20%"><b>Keterangan</b></td>
                                    ...
                                    <?php 
                                        ...
                                        while ($tampil = mysqli_fetch_array($sql)) {
                                            $no++;
                                                        $kode_akun=$tampil['kode_akun'];
                                                        $kode_akun_biaya=$tampil['kode_akun_biaya'];
                                        ...
                                        WHERE kode_cabang='$kd_cabang_trx'");			
                                            ...
                                            $tot_jml=$tot_jml+$tampil['keluar'];
                                    ?>
                                        <tr>
                                            <td class="center"><?php echo $no; ?></td>														
                                            <td><?php echo $tampil['kode_km']?></td>														
                                            <td class="center"><?php echo $tampil['tanggal_trx']?></td>				
                                            <td><?php echo $tampil['uraian']?></td>				   
														<td align="right"><?php echo number_format($tampil['keluar'],0)?></td>						
														<td><?php echo $namaakun; ?></td>
                                                        <td>
                                                            <?php echo $tampil['kode_akun_biaya']?>&nbsp;-&nbsp;
...
<td><?php echo $nama_cabang_trx; ?></td>																															
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" bgcolor="gainsboro"><b><?php echo number_format($tot_jml,0); ?></b></td>
