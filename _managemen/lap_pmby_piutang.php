<?php
    ...
    // ---- SQL Total Data -----                            
		...
		if(isset($_POST['btnpdf'])) {				
			...
			echo"<script>window.location=('lap_pmby_piutang_pdf.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai&ssup=$nopelanggan');</script>";                        
        }        
		if(isset($_POST['btnxl'])) {				
            $tgl_pilih_dari= $_POST['id-date-picker-1'];
            $tgl_pilih_sampai= $_POST['id-date-picker-2'];            
            $nopelanggan= $_POST['txtpelanggan'];
			echo"<script>window.location=('lap_pmby_piutang_xls.php?stgl1=$tgl_pilih_dari&stgl2=$tgl_pilih_sampai&ssup=$nopelanggan');</script>";                        
        }        
?>
...
<?php include "menu_laporan06.php"; ?>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td bgcolor="gainsboro" width="30%"><b>Nama Pelanggan</b></td>
                                    ...
                                    <?php 
                                        ...
                                        while ($tampil = mysqli_fetch_array($sql)) {
                                            $no++;
                                            $tot_jual=$tot_jual+$tampil['total_bayar'];
$kd_cabang_trx=$tampil['kd_cabang'];
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="center"><?php echo $tampil['no_transaksi']?></td>														
