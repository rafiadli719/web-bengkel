                                ...
                                <div class="col-xs-3">
                                    <select class="col-xs-10 col-sm-12" name="cbotgl" id="cbotgl" >
                                        ...
                                        <?php
                                            ...
                                            {
                                        ?>
                                        <option value="<?php echo $sql_res["tgl"]; ?>"><?php echo $sql_res["tanggal_absen"]; ?></option>
                                        <?php
                                            }
                                        ?>
                                    </select>                
...
<th class="center">Aksi</th>
												...
												<?php 
													...
													$sql = mysqli_query($koneksi,"SELECT
                                                                                    ...
                                                                                    jam_masuk, jam_keluar, id, id_upload, keterangan, 
                                                                                    kode_status_kehadiran 
																					FROM tbabsensi 
                                                                                    WHERE nip<>'0' AND id_upload='$id_upload' 
...
<td class="center">													
															<a class="green" data-rel="tooltip" title="Edit" 
																href="absensi_edit_upl.php?kd=<?php echo $tampil['id']?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>&nbsp;
															<a class="red" data-rel="tooltip" title="Delete" 
																href="absensi_del_upl.php?kd=<?php echo $tampil['id']?>&idupl=<?php echo $tampil['id_upload']?>" 
