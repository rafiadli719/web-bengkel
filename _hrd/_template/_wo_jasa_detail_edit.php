                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="wo_edit_jasa_detail.php?sid=<?php echo $tampil['id']; ?>&kdwo=<?php echo $no_wo; ?>">Edit Item</a>
                                                        </li>
                                                        <li>
                                                            <a href="wo_hapus_jasa_detail.php?sid=<?php echo $tampil['id']; ?>&kdwo=<?php echo $no_wo; ?>" 
