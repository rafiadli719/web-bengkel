<?php
    ...
    // --------------------
		...
		if(isset($_POST['btndownload'])) {				 
			...
			$awal1="&sbulan=";
			$next = 'location:laporan_payroll_pdf.php?stahun=';
			$awal = $next.$txttahun.$awal1.$cbobulan;
			header($awal);
		}
...
$awal1="&sbulan=";
			$next = 'location:laporan_payroll_excel.php?stahun=';
			$awal = $next.$txttahun.$awal1.$cbobulan;
			header($awal);			
		}		
?>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">	
											<form class="form-horizontal" action="laporan_absensi_rst.php" method="get">	

												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tahun </label>									
													<div class="col-sm-9">
														<input type="text" id="txttahun" name="txttahun" class="col-xs-10 col-sm-9" value="<?php echo $tahun_skr; ?>" />
													</div>
												</div>																	
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Bulan </label>									
													<div class="col-sm-9">
															<select class="col-xs-10 col-sm-9" name="cbobulan" id="cbobulan" required >
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
															<select class="col-xs-10 col-sm-9" name="cbocabang" id="cbocabang" required >
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<button class="btn btn-info" type="submit">
															<i class="ace-icon fa fa-search bigger-110"></i>Tampilkan
														</button>							
													</div>
												</div>																		
											</form>
