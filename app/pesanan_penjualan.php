<?php
    ...
    // --------------------
        ...
        // Count total records
        $count_query = "SELECT COUNT(*) as total FROM tblorderjual_header oh WHERE oh.kd_cabang='$kd_cabang'";
        ...
        $sql_query = "SELECT oh.*, 
                             ...
                             COALESCE(s.namasales, '') as namasales
                      FROM tblorderjual_header oh
                      LEFT JOIN tblpelanggan p ON oh.no_pelanggan = p.nopelanggan
                      LEFT JOIN tblsales s ON oh.no_sales = s.nosales
                      WHERE oh.kd_cabang='$kd_cabang'
		...
		if(isset($_POST['btnasc'])) {				
			...
			echo"<script>window.location=('pesanan_penjualan_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
			echo"<script>window.location=('pesanan_penjualan_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";            
        }
?>
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <form class="form-horizontal" action="" method="post" role="form">
                                                <?php include "_template/_pesanan_penjualan_cari.php"; ?>
                                            </form>
                                        </div>
									</div>
								</div>	
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="center" width="10%">No. Pesanan</td>
                                            <td class="center" width="9%">Tanggal</td>
                                            <td width="9%">Kode Pelanggan</td>
                                            <td width="10%">Nama Pelanggan</td>
                                            <td width="10%">Sales</td>
                                            <td width="9%" align="right">Total Qty</td>
                                            <td width="10%" align="right">Total Jual</td>
                                            <td width="9%" align="right">Diskon</td>
                                            <td width="9%" align="right">Pajak</td>
                                            <td width="10%" align="right">Total Akhir</td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php 
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                                    <li>
                                                                        <a href="pesanan_penjualan_detail.php?nopesanan=<?php echo $tampil['no_order']; ?>">Detail Pesanan</a>
                                                                    </li>
                                                                    <li>
                                                                        <a target="_blank" href="pesanan_penjualan_struk.php?snobl=<?php echo $tampil['no_order']; ?>">Cetak</a>
                                                                    </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>														
