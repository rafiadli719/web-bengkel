...
'.nota_pdf_header($file_logo, $nama_perusahaan, $alamat, $notlp, $fax, 'PENYESUAIAN STOK ITEM KELUAR', array(
            array('No', $notrx),
...
$dompdf->stream('penyesuaian-stok-keluar.pdf',array("Attachment"=>0));
?>
