...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Laporan Piutang Detail | <?php include "../lib/titel.php"; ?></title>

		<meta name="description" content="Laporan Piutang Detail per Transaksi per Pelanggan" />
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Laporan Piutang Detail</li>
						</ul><!-- /.breadcrumb -->
					</div>
								...
								<div class="widget-box">
									<div class="widget-header widget-header-green widget-header-flat">
                                        ...
                                        <div class="widget-toolbar">
                                            ...
                                            <a href="laporan_piutang_summary.php" class="btn btn-xs btn-info">
										...
										<div class="widget-main no-padding">
                                            ...
                                            <div style="padding: 15px;">
                                                <h4 class="text-center">
                                                    <strong>LAPORAN PIUTANG DETAIL PER PELANGGAN</strong><br>
                                            ...
                                            <?php
                                            // Query untuk get list pelanggan yang punya piutang
                                            ...
                                            <div style="padding: 15px; page-break-inside: avoid;">
                                                <h5 style="background-color: #f0f0f0; padding: 10px; margin-bottom: 10px;">
                                                    <strong>** <?php echo strtoupper($nama_pelanggan); ?> **</strong><br>
                                                    <small><?php echo $pelanggan['alamatpelanggan']; ?> | Telp: <?php echo $pelanggan['tlppelanggan']; ?></small>
                                                </h5>
                                                ...
                                                <table class="table table-bordered table-condensed">
                                                    <thead>
                                                        <tr style="background-color: #e0e0e0;">
                                                            ...
                                                            <th width="15%" class="text-right">Sudah Bayar</th>
                                                            <th width="15%" class="text-right">Sisa Piutang</th>
                                                    ...
                                                    if(mysqli_num_rows($result_detail) > 0) {
                                                        while($detail = mysqli_fetch_array($result_detail)) {
                                                            $sisa = $detail['sisa_piutang'];
                                                            $total_pelanggan += $sisa;
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $detail['tgl_lunas'] ? $detail['tgl_lunas'] : '-'; ?></td>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td colspan="7" class="text-center text-muted">
                                                                <em>Tidak ada piutang untuk pelanggan ini</em>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
                                                    ...
                                                    <tfoot>
                                                        <tr style="background-color: #fff3cd;">
                                                            <td colspan="4" class="text-right"><strong>TOTAL <?php echo strtoupper($nama_pelanggan); ?>:</strong></td>
                                                            <td class="text-right"><strong style="font-size: 14px;">Rp <?php echo number_format($total_pelanggan,0); ?></strong></td>
                                                            <td colspan="2"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            ...
                                            <div style="padding: 15px; background-color: #d4edda; margin: 15px;">
                                                <h4 class="text-right">
                                                    <strong>GRAND TOTAL PIUTANG: Rp <?php echo number_format($grand_total,0); ?></strong>
                                                </h4>
                                            </div>
                                            ...
                                            <div class="alert alert-info text-center" style="margin: 20px;">
                                                ...
                                                Tidak ada data piutang untuk periode yang dipilih.
                                            </div>
                                            <?php } ?>
