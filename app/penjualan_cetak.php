<?php
    ...
    // --------------------
		...
		$nojl=mysqli_real_escape_string($koneksi, $_GET['nopesanan']);        
		$cari_kd=mysqli_query($koneksi,"SELECT *,  
        ...
        $note=$tm_cari['note']; 
        $tanggal_jt=$tm_cari['tanggal_tempo'];
...
// =========
        ...
        $total_qty_retur=$tm_cari['tot_qty_retur'];            
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Cetak Struk</li>
						</ul><!-- /.breadcrumb -->
					</div>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">	
                                            <br>
                                            <?php include "_template/_penjualan_header_cetak.php"; ?>
										</div>
									</div>
								</div>	
							</div>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_penjualan_detail_cetak.php"; ?>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_penjualan_lainnya_cetak.php"; ?>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_penjualan_total_cetak.php"; ?>
