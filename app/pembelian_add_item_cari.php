<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {	
			...
			$cbo_supplier= mysqli_real_escape_string($koneksi, $_POST['txtsup']);
			$txtpesan= mysqli_real_escape_string($koneksi, $_POST['txtpesan']);                        
            ...
            echo"<script>window.location=('pembelian_add_item_cari.php?stgl=$tgl_pilih&ssup=$cbo_supplier&spesan=$txtpesan&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= mysqli_real_escape_string($koneksi, $_POST['cbocari']);	
			$cbourut= mysqli_real_escape_string($koneksi, $_POST['cbourut']);
            echo"<script>window.location=('pembelian_add_item_cari.php?stgl=$tgl_pilih&ssup=$cbo_supplier&spesan=$txtpesan&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";
        }
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <form class="form-horizontal" action="" method="post" role="form">
                                                ...
                                                <input type="hidden" name="txtsup"  class="form-control" value="<?php echo $cbo_supplier; ?>"/>                        
                                                <input type="hidden" name="txtpesan"  class="form-control" value="<?php echo $spesan; ?>"/>                                                                        
                                                <?php include "_template/pembelian/_cari_item.php"; ?>
                                            </form>
                                        </div>
									</div>
								</div>	
							...
							<div class="col-xs-12">
                                <div class="widget-box">
                                    <div class="widget-header widget-header-green widget-header-flat">
                                        ...
                                        <div class="widget-toolbar">
                                            <a href="pembelian_add.php?tab=item-barang" class="btn btn-xs btn-light">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                ?>
                                                    <tr>
                                                        <td class="center">
                                                            <div class="btn-group">
                                                                <a href="pembelian_add_rst.php?stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $cbo_supplier; ?>&kd=<?php echo $tampil['noitem']; ?>&spesan=<?php echo $spesan; ?>" 
