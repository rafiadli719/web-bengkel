                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                ?>
                                                    <tr>
                                                        <td class="center">
                                                            <div class="btn-group">
                                                                <a href="penjualan_add_rst.php?stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $tampil['nopelanggan']; ?>&ssales=<?php echo $cbosales; ?>&kd=<?php echo $noitem; ?>&spesan=<?php echo $spesan; ?>" 
