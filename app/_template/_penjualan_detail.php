                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="penjualan_edit_item.php?sid=<?php echo $tampil['id']; ?>&stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $nopelanggan; ?>&spesan=<?php echo $nopesanan; ?>&ssales=<?php echo $cbosales; ?>">Edit Item</a>
                                                        </li>
                                                        <li>
                                                            <a href="penjualan_hapus_item.php?sid=<?php echo $tampil['id']; ?>&stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $nopelanggan; ?>&spesan=<?php echo $nopesanan; ?>&ssales=<?php echo $cbosales; ?>" 
