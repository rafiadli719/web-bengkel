                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control text-right" id="txtbayar" name="txtbayar" 
                                           value="<?php echo number_format($bayar, 0, ',', '.'); ?>" readonly />
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="cbokepala_mekanik1" id="cbokepala_mekanik1" class="form-control" disabled>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="number" name="txtpersen_kepala1" id="txtpersen_kepala1" 
                                           class="form-control" disabled value="<?php echo isset($persen_kepala1) ? $persen_kepala1 : '0'; ?>" 
                                           min="0" max="100" />
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="cbomekanik1" id="cbomekanik1" class="form-control" disabled required>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="number" name="txtpersen_mekanik1" id="txtpersen_mekanik1" 
                                           class="form-control" disabled value="<?php echo isset($persen_kerja1) ? $persen_kerja1 : '0'; ?>" 
                                           min="0" max="100" />
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="cbomekanik2" id="cbomekanik2" class="form-control" disabled>
                                    <option value="">- Pilih Mekanik -</option>
                                    <?php
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="number" name="txtpersen_mekanik2" id="txtpersen_mekanik2" 
                                           class="form-control" disabled value="<?php echo isset($persen_kerja2) ? $persen_kerja2 : '0'; ?>" 
                                           min="0" max="100" />
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="cbokepala_mekanik2" id="cbokepala_mekanik2" class="form-control" disabled>
                                    <option value="">- Pilih Kepala Mekanik -</option>
                                    <?php
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="number" name="txtpersen_kepala2" id="txtpersen_kepala2" 
                                           class="form-control" disabled value="<?php echo isset($persen_kepala2) ? $persen_kepala2 : '0'; ?>" 
                                           min="0" max="100" />
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="cbomekanik3" id="cbomekanik3" class="form-control" disabled>
                                    <option value="">- Pilih Mekanik -</option>
                                    <?php
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="number" name="txtpersen_mekanik3" id="txtpersen_mekanik3" 
                                           class="form-control" disabled value="<?php echo isset($persen_kerja3) ? $persen_kerja3 : '0'; ?>" 
                                           min="0" max="100" />
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="cbomekanik4" id="cbomekanik4" class="form-control" disabled>
                                    <option value="">- Pilih Mekanik -</option>
                                    <?php
