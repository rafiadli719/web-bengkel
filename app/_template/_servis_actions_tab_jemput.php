<!-- Tab Actions Jemput - Enhanced with Payment -->
            ...
            <div class="padding-18">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-info">
                            ...
                            <?php if($kategori_pelanggan && $kategori_pelanggan != '001'): ?>
                                ...
                                ?>
                            <?php endif; ?>
                            | <i class="ace-icon fa fa-truck"></i> <strong>Service Jemput</strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        (function() {
                            function toggleBuktiPembayaranJemputNonRST() {
                            ...
                            if (document.readyState === 'loading') {
                                document.addEventListener('DOMContentLoaded', toggleBuktiPembayaranJemputNonRST);
                            } else {
                                toggleBuktiPembayaranJemputNonRST();
                            }
                            
                            // Add event listener
                            var metodeBayar = document.getElementById('metode_pembayaran');
                            if (metodeBayar) {
                                metodeBayar.addEventListener('change', toggleBuktiPembayaranJemputNonRST);
                            }
                        })();
                        </script>
                        ...
                        <!-- Jemput Specific Info -->
                        <div class="alert alert-success">
                            <i class="ace-icon fa fa-truck"></i>
                            <strong>Info Jemput:</strong> Kendaraan akan diantar kembali setelah pembayaran selesai.
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="number" name="txtpersen_mekanik1" id="txtpersen_mekanik1"
                                           class="form-control" value="<?php echo isset($persen_mekanik1) ? $persen_mekanik1 : '0'; ?>"
                                           min="0" max="100" />
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="number" name="txtpersen_mekanik2" id="txtpersen_mekanik2"
                                           class="form-control" value="<?php echo isset($persen_mekanik2) ? $persen_mekanik2 : '0'; ?>"
                                           min="0" max="100" />
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="number" name="txtpersen_mekanik3" id="txtpersen_mekanik3"
                                           class="form-control" value="<?php echo isset($persen_mekanik3) ? $persen_mekanik3 : '0'; ?>"
                                           min="0" max="100" />
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="number" name="txtpersen_mekanik4" id="txtpersen_mekanik4"
                                           class="form-control" value="<?php echo isset($persen_mekanik4) ? $persen_mekanik4 : '0'; ?>"
                                           min="0" max="100" />
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
...
(function() {
    if (typeof jQuery === 'undefined') {
        document.addEventListener('DOMContentLoaded', initServiceActionsJemput);
    } else {
        jQuery(document).ready(initServiceActionsJemput);
    }

    function initServiceActionsJemput() {
        var $ = jQuery;
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success && response.has_data) {
                        ...
                        // Kepala Mekanik 1: match by text/value, append if not found
                        ...
                        if (filled && typeof window.autoCalculatePercentage==='function') { window.autoCalculatePercentage(); }
                        ...
                        alert((response && response.message) || 'Belum ada data kepala mekanik untuk hari ini');
                        if (response && response.redirect_url) { setTimeout(function(){ window.location.href=response.redirect_url; }, 2000); }
                    }
                },
                error: function() {
