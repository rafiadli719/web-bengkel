...
?>
        ...
        <div class="widget-box">
            <div class="widget-body">
                <div class="widget-main">
                    ...
                    <?php include "_template/_servis_byr_cetak_detail_servis.php"; ?> 
                </div>
            </div>
        </div>
        ...
        <div class="widget-box">
            <div class="widget-body">
                <div class="widget-main">
                    ...
                    <?php include "_template/_servis_byr_cetak_detail_barang.php"; ?> 
                </div>
            </div>
        </div>
        ...
        <div class="widget-box">
            <div class="widget-body">
                <div class="widget-main">
                    <?php include "_template/_servis_byr_cetak_total.php"; ?> 
                </div>
            </div>
        </div>