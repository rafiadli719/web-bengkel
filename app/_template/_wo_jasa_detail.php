                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="wo_edit_jasa.php?sid=<?php echo $tampil['id']; ?>&snamawo=<?php echo $txtnamawo; ?>&sketwo=<?php echo $txtketwo; ?>&swaktu=<?php echo $txtwaktu; ?>">Edit Item</a>
                                                        </li>
                                                        <li>
                                                            <a href="wo_hapus_jasa.php?sid=<?php echo $tampil['id']; ?>&snamawo=<?php echo $txtnamawo; ?>&sketwo=<?php echo $txtketwo; ?>&swaktu=<?php echo $txtwaktu; ?>" 
