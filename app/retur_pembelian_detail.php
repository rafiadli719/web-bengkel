            ...
            <div class="main-content-inner">
                ...
                <div class="page-content">
                    ...
                    <div class="alert alert-success">
                        <i class="fa fa-check-circle"></i> <strong>Retur pembelian berhasil disimpan!</strong>
                        No. Retur: <strong><?php echo htmlspecialchars($noretur); ?></strong>
                    </div>
                    <?php endif; ?>
                    <?php if($approved): ?>
                    <div class="alert alert-success">
                        <i class="fa fa-check-circle"></i> <strong>Retur pembelian berhasil disetujui!</strong> Status diubah menjadi <strong>Selesai</strong>.
                    </div>
                    <?php endif; ?>
                        ...
                        <div class="col-xs-12">
                            <div class="widget-box">
                                <div class="widget-header">
                                    <h4 class="widget-title"><i class="fa fa-undo"></i> Detail Retur Pembelian</h4>
                                    <div class="widget-toolbar">
                                        <?php if($h['status_retur'] == '0'): ?>
                                        <a href="retur_pembelian_approve.php?noretur=<?php echo urlencode($noretur); ?>"
                                           class="btn btn-sm btn-success"
                                           onclick="return confirm('Setujui retur ini? Status akan berubah menjadi Selesai.');">
                                            <i class="fa fa-check"></i> Setujui
                                        </a>
                                        <a href="retur_pembelian_batal.php?noretur=<?php echo urlencode($noretur); ?>"
                                           class="btn btn-sm btn-danger"
                                           onclick="return confirm('Batalkan retur ini? Data akan dihapus permanen.');">
                                            <i class="fa fa-trash"></i> Batal
                                        </a>
                                        <?php endif; ?>
                                        <a href="retur_pembelian_cetak.php?noretur=<?php echo urlencode($noretur); ?>" target="_blank" class="btn btn-sm btn-info">
                                            <i class="fa fa-print"></i> Cetak
                                        </a>
                                        <a href="retur_pembelian_rst.php?_key=&_cari=" class="btn btn-sm btn-default">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6">
                                                <table class="table table-condensed">
                                                    ...
                                                    <tr><td><strong>No. Pembelian</strong></td><td><?php echo htmlspecialchars($h['nopembelian']); ?></td></tr>
                                                    <tr><td><strong>Supplier</strong></td><td><?php echo htmlspecialchars($h['namasupplier']); ?></td></tr>
