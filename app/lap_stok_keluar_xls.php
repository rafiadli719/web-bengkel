<?php
    ...
    $nama_file="Laporan Penyesuaian Stok (Item Keluar) ".$tgl_pilih_dari." s/d ".$tgl_pilih_sampai.".xls";
?>
...
<body>
	...
	?>
										...
										<b>
										<h4>
										Laporan Penyesuaian Stok (Item Keluar)<br> Periode <?php echo $tgl_pilih_dari; ?>&nbsp;s/d&nbsp;<?php echo $tgl_pilih_sampai; ?>
										</h4>
										</b> 
