<?php  
            ...
            // ---------------------
                ...
                if($stok_akhir=='0') {
                    ...
                    window.location=('pesanan_penjualan_add_rst.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&kd=$txtkdbarang&tab=item-barang');</script>";			                                                                        
                } else {
                    if($txtqty>$stok_akhir) {
                        ...
                        if($stok_proses<0) {
                            ...
                            if($cek > 0){
                                ...
                                localStorage.setItem('activeTab', '#item-barang');
                                window.location=('pesanan_penjualan_add_rst.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&kd=$kdbrg&tab=item-barang');</script>";			                                                                        
                            } else {
