<?php  
            ...
            // ---------------------
                ...
                if($stok_akhir=='0') {
                    ...
                    window.location=('penjualan_add_rst.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&kd=$txtkdbarang&spesan=$nopesanan');</script>";			                                                    
                } else {
                    if($txtqty>$stok_akhir) {
                        ...
                        if($stok_proses<0) {
                            ...
                            $data = mysqli_query($koneksi,"SELECT * FROM tblpenjualan_detail 
                                                                WHERE 
