<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {
            ...
            echo"<script>window.location=('servis-garansi-item-cari.php?snoserv=" . urlencode($no_service) . "&_key=" . urlencode($txtkey) . "&_cari=" . urlencode($cbocari) . "&_urut=" . urlencode($cbourut) . "&_flt=asc');</script>";
        }
		...
		if(isset($_POST['btndesc'])) {
			...
			$cbocari= $_POST['cbocari'];
			$cbourut= $_POST['cbourut'];
            echo"<script>window.location=('servis-garansi-item-cari.php?snoserv=" . urlencode($no_service) . "&_key=" . urlencode($txtkey) . "&_cari=" . urlencode($cbocari) . "&_urut=" . urlencode($cbourut) . "&_flt=desc');</script>";
        }
