...
<html lang="en">
	<head>
		...
		<meta name="description" content="Tambah Staff Admin" />
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="staff_admin.php">Staff Admin</a>
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" action="staff_admin_save.php" method="post" enctype="multipart/form-data">

									<div class="widget-box">
										<div class="widget-header widget-header-blue widget-header-flat">
											<h4 class="widget-title lighter">
												<i class="ace-icon fa fa-user-plus"></i>
												Tambah Staff Admin - Data Master & User Login
											</h4>
										</div>
											...
											<div class="widget-main">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														required autocomplete="off" placeholder="Nama lengkap staff admin" />
													</div>
												</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a href="staff_admin.php" class="btn btn-default">
