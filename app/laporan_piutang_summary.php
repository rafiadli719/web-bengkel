...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Laporan Piutang Summary | <?php include "../lib/titel.php"; ?></title>

		<meta name="description" content="Laporan Piutang Summary per Pelanggan" />
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Laporan Piutang Summary</li>
						</ul><!-- /.breadcrumb -->
					</div>
								...
								<div class="widget-box">
									<div class="widget-header widget-header-green widget-header-flat">
                                        ...
                                        <div class="widget-toolbar">
                                            ...
                                            <a href="laporan_piutang_detail.php" class="btn btn-xs btn-primary">
										...
										<div class="widget-main no-padding">
                                            ...
                                            <div style="padding: 15px;">
                                                <h4 class="text-center">
                                                    <strong>*UPDATE PIUTANG PELANGGAN*</strong><br>
                                                    <small>Periode s.d : <?php echo date('d-M-y', strtotime($tgl_sampai_sql)); ?></small><br>
                                            ...
                                            $sql_summary = "SELECT 
                                                        ...
                                                        WHERE pj.carabayar = 'Kredit'
                                                            ...
                                                            AND pj.tanggal BETWEEN '$tgl_dari_sql' AND '$tgl_sampai_sql'
                                            ...
                                            <div style="padding: 20px;">
                                                ...
                                                if(mysqli_num_rows($result_summary) > 0) {
                                                    while($summary = mysqli_fetch_array($result_summary)) {
                                                        $no_pelanggan = $summary['no_pelanggan'];
                                                        $nama_pelanggan = $summary['namapelanggan'];
                                                        $total_piutang = $summary['total_piutang'];
                                                        $jumlah_transaksi = $summary['jumlah_transaksi'];
                                                        
                                                        $grand_total += $total_piutang;
                                                        $total_customers++;
                                                ?>
                                                
                                                <div style="margin-bottom: 20px; padding: 15px; background-color: #f9f9f9; border-left: 4px solid #5bc0de;">
                                                    <h5 style="margin-top: 0;">
                                                        <strong>** <?php echo strtoupper($nama_pelanggan); ?>*</strong>
                                                    </h5>
                                                    <p style="margin: 5px 0; color: #666;">
                                                        <i class="fa fa-map-marker"></i> <?php echo $summary['alamatpelanggan']; ?><br>
                                                        <i class="fa fa-phone"></i> <?php echo $summary['tlppelanggan']; ?>
                                                    </p>
                                                    <div style="margin-top: 10px;">
                                                        <span class="label label-info" style="font-size: 12px; margin-right: 10px;">
                                                            <i class="fa fa-file-text"></i> <?php echo $jumlah_transaksi; ?> Transaksi
                                                        </span>
                                                        <span class="label label-danger" style="font-size: 13px;">
                                                            <i class="fa fa-money"></i> Total: Rp <?php echo number_format($total_piutang, 0); ?>
                                                        </span>
                                                    </div>
                                                    <div style="margin-top: 10px;">
                                                        <a href="laporan_piutang_detail.php" class="btn btn-xs btn-info">
                                                ...
                                                <div style="margin-top: 30px; padding: 20px; background-color: #d4edda; border: 2px solid #28a745; border-radius: 5px;">
                                                    <div class="row">
                                                        <div class="col-sm-8">
                                                            ...
                                                            <p style="margin: 5px 0; color: #666;">
                                                                Total Pelanggan: <?php echo $total_customers; ?> pelanggan
                                                            </p>
                                                        </div>
                                                ...
                                                <div class="alert alert-info text-center">
                                                    ...
                                                    <strong>Tidak ada data piutang untuk periode yang dipilih.</strong>
                                                </div>
                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <p class="text-center text-muted">pelanggan dengan piutang aktif</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <p class="text-center text-muted">total piutang belum lunas</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <h2 class="text-center text-warning">
                                                Rp <?php echo number_format($grand_total / $total_customers, 0); ?>
                                            </h2>
                                            <p class="text-center text-muted">rata-rata piutang per pelanggan</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
