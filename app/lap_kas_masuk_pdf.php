<?php
    ...
    $nama_file="Laporan Kas Masuk ".$tgl_pilih_dari." s/d ".$tgl_pilih_sampai.".pdf";
	...
	$html = '<table style="margin: 0 0pt; width: 100%; border-collapse:collapse;" border="0">
                <tr>
                    <td align="center"><b>Laporan Kas Masuk <br>Periode '.$tgl_pilih_dari.' s/d '.$tgl_pilih_sampai.'</b></td>
                </tr>
            </table>
            <br>
            ...
            $html .= "<tr valign=top>
                ...
                <td>".$row['uraian']."</td>		
                <td align=right>".number_format($row['masuk'])."</td>
                <td>".$namaakun."</td>
