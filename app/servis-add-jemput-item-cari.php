<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {
            ...
            echo"<script>window.location=('servis-add-jemput-item-cari.php?snoserv=" . urlencode($no_service) . "&_key=" . urlencode($txtkey) . "&_cari=" . urlencode($cbocari) . "&_urut=" . urlencode($cbourut) . "&_flt=asc');</script>";
        }
		...
		if(isset($_POST['btndesc'])) {
			...
			$cbocari= mysqli_real_escape_string($koneksi, $_POST['cbocari']);
			$cbourut= mysqli_real_escape_string($koneksi, $_POST['cbourut']);
            echo"<script>window.location=('servis-add-jemput-item-cari.php?snoserv=" . urlencode($no_service) . "&_key=" . urlencode($txtkey) . "&_cari=" . urlencode($cbocari) . "&_urut=" . urlencode($cbourut) . "&_flt=desc');</script>";
        }
                                    ...
                                    ?>
                                        <tr class="<?php echo $row_class; ?>">
                                            <td class="center">
                                                ...
                                                <?php } else { ?>
                                                    <a href="servis-input-reguler-jemput-rst.php?snoserv=<?php echo $no_service; ?>&kd=<?php echo $tampil['noitem']; ?>&tab=<?php echo $tab_param; ?>" 
