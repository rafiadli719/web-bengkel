<?php
    ...
    if ($dupRow && (int)$dupRow['c'] > 1) {
        die("No_service ini terdeteksi dipakai lebih dari 1 cabang (data legacy bermasalah). Batal tidak bisa diproses otomatis, hubungi admin untuk penanganan manual.");
    }
