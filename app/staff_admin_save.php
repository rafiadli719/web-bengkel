...
try {
    ...
    // 2. Insert into tb_staff_admin
    $staff_query = "INSERT INTO tb_staff_admin (user_id, nama_staff, email, telepon, alamat, foto, status_staff)
                    VALUES ('$user_id', '$nama_staff', '$email', '$telepon', '$alamat', '$foto_path', '$status_staff')";
    ...
    echo "<script>
        alert('Data Staff Admin berhasil disimpan!');
