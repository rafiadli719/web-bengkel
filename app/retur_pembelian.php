...
if(empty($_SESSION['_iduser'])){
    ...
    if(isset($_POST['btncari'])) {
        ...
        echo "<script>window.location=('retur_pembelian_rst.php?_key=$txtkey&_cari=$cbocari');</script>";
    }
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="col-xs-12">
                            <div class="widget-box">
                                <div class="widget-header">
                                    <h4 class="widget-title"><i class="fa fa-undo"></i> Retur Pembelian</h4>
                                </div>
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <form class="form-inline" action="" method="post">
                                            ...
                                            <a href="retur_pembelian_rst.php?_key=&_cari=" class="btn btn-default">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <a href="retur_pembelian_add.php">
                                <button class="btn btn-success btn-block" type="button">
                                    <i class="fa fa-plus"></i> Input Retur Pembelian
                                </button>
                            </a>
                        </div>
                    </div>
