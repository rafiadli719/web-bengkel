    ...
    // --------------------
		...
		if(isset($_POST['btncari_pesanan'])) {
            ...
            if($nopesanan<>'') {
                ...
                // End ====
                    ...
                    window.location=('penjualan_add_rst.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&kd=$kdbrg&spesan=$nopesanan');</script>";			                                                                        
                }
            }
            ...
            $total_qty_jual=$tm_cari['tot_qty_jual'];                                 
		...
		if(isset($_POST['btncari_pelanggan'])) {
            ...
            if($tot_cari=='1') {
                ...
                $cbocari="";
                $cbourut="23";
                echo"<script>window.location=('penjualan_add_pelanggan_cari.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&_key=$nopelanggan&spesan=$nopesanan&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";                
            }
		...
		if(isset($_POST['btncari'])) {				
            ...
            if($tot_cari=='1') {
                ...
                $cbocari="";
                $cbourut="35";
                echo"<script>window.location=('penjualan_add_item_cari.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&spesan=$nopesanan&_key=$txtcaribrg&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
            }
        ...
        if(isset($_POST['btnadd'])) {	
            include "proses-add-detail/penjualan.php"; 
        }     

        if(isset($_POST['btnsimpan'])) {
            $txttotal_harga= mysqli_real_escape_string($koneksi, $_POST['txttotal_harga']);            
            if($txttotal_harga=='0') {
                echo"<script>window.alert('Belum ada Item barang yang dipilih. Transaksi tidak dapat disimpan!');window.location=('penjualan_add.php');</script>";
            } else {
...
'$nopesanan','','$cbosales','$nopelanggan',
'$txtnote',
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <input type="hidden" name="active_tab" id="active_tab" value="sales-details"/>
						<div class="row">
							<div class="col-xs-12">
								<div class="widget-box">
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">
											<i class="ace-icon fa fa-cash-register orange"></i>
											Penjualan #<?php echo $LastID; ?>
										</h4>
                                        <div class="widget-toolbar">
                                            <span class="label label-success arrowed-in arrowed-in-right">Sales Transaction</span>
                                        </div>
									</div>
												...
												<div class="tab-content">
														...
														<div class="row">
															<div class="col-xs-12">
																<div class="padding-18">
																	<?php include "_template/_penjualan_header.php"; ?>
																	...
																	<div class="row">
																		<div class="col-xs-12">
																			<div class="form-group">
																				...
																				<div class="col-sm-10">
																					<textarea class="form-control" id="txtnote" name="txtnote" rows="3" placeholder="Keterangan penjualan..."></textarea>
																				</div>
																			</div>
																		</div>
																	</div>
													...
													<div id="sales-items" class="tab-pane fade">
														<div class="row">
															<div class="col-xs-12">
																<div class="padding-18">
																	<?php include "_template/_penjualan_detail.php"; ?>
																</div>
															</div>
														</div>
													</div>
														...
														<div class="row">
															<div class="col-xs-12">
																<div class="padding-18">
																	...
																	<div class="row">
																		<div class="col-sm-7">
																			<?php include "_template/_penjualan_lainnya.php"; ?>
																		</div>
																		<div class="col-sm-5">
																			<?php include "_template/_penjualan_total.php"; ?>
																		</div>
																	</div>
																	...
																	<div class="row">
																		...
																		<div class="col-xs-3">
																			<a href="penjualan_batal.php?suser=<?php echo $_nama; ?>&scabang=<?php echo $kd_cabang; ?>" 
																			onclick="return confirm('Inputan Penjualan akan dibatalkan. Lanjutkan?')">                                                                    
