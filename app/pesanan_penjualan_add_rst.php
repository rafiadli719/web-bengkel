<?php
    ...
    // --------------------
        ...
        $target_tab = isset($_GET['tab']) ? mysqli_real_escape_string($koneksi, $_GET['tab']) : 'order-details';                                                            
    ...
    // Total Transaksi ======
		...
		if(isset($_POST['btncari'])) {				
            ...
            if($tot_cari=='1') {
                ...
                $cbocari="";
                $cbourut="35";
                echo"<script>window.location=('pesanan_penjualan_add_item_cari.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&_key=$txtcaribrg&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
            }
