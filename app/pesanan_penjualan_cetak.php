								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">	
                                            <br>
                                            <?php include "_template/_pesanan_penjualan_header_cetak.php"; ?>
										</div>
									</div>
								</div>	
							</div>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_pesanan_penjualan_detail_cetak.php"; ?>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_pesanan_penjualan_lainnya_cetak.php"; ?>
								...
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">
                                            ...
                                            <?php include "_template/_pesanan_penjualan_total_cetak.php"; ?>
