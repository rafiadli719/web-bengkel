<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {	
			...
			$cbocabang= mysqli_real_escape_string($koneksi, $_POST['txtsup']);
            ...
            echo"<script>window.location=('pesanan_penjualan_cab_add_item_cari.php?stgl=$tgl_pilih&ssup=$cbocabang&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= mysqli_real_escape_string($koneksi, $_POST['cbocari']);	
			$cbourut= mysqli_real_escape_string($koneksi, $_POST['cbourut']);
            echo"<script>window.location=('pesanan_penjualan_cab_add_item_cari.php?stgl=$tgl_pilih&ssup=$cbocabang&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";
        }
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <form class="form-horizontal" action="" method="post" role="form">
                                                ...
                                                <input type="hidden" name="txtsup"  class="form-control" value="<?php echo $cbocabang; ?>"/>                        
                                ...
                                <div class="widget-box">
                                    <div class="widget-header widget-header-green widget-header-flat">
                                        ...
                                        <div class="widget-toolbar">
                                            <a href="pesanan_penjualan_cab_add.php" class="btn btn-xs btn-light">
                                    ...
                                    <?php 
                                        ...
                                        while ($tampil = mysqli_fetch_array($sql)) {
                                                ...
                                                $cari_stok=mysqli_query($koneksi,"SELECT saldo 
                                                                                ...
                                                                                no_item='$noitem'");			
                                                $tm_stok=mysqli_fetch_array($cari_stok);
                                                $saldo_akhir = ($tm_stok && isset($tm_stok['saldo'])) ? $tm_stok['saldo'] : 0;
                                    ...
                                    ?>
                                                    <tr class="<?php echo $row_class; ?>">
                                                        <td class="center">
                                                            ...
                                                            <?php } else { ?>
                                                                <a href="pesanan_penjualan_cab_add_rst.php?stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $cbocabang; ?>&kd=<?php echo $tampil['noitem']; ?>" 
