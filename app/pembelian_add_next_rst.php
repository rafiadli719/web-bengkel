<?php
	...
	if(empty($_SESSION['_iduser'])){
		...
		$nopesanan=mysqli_real_escape_string($koneksi, $_GET['noorder']);
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-5">
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label no-padding-right" for="txtnopesanan"> No. Pembelian :</label>									
                                                        <div class="col-sm-7">
                                                            <input type="text" class="form-control" value="<?php echo $nopesanan; ?>" disabled />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-5">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <?php
                                                                $q = mysqli_query($koneksi,"select nosupplier, namasupplier FROM tblsupplier");
							...
							<div class="col-xs-12 col-sm-12">
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">	
                                            <div class="row">
                                                <form class="form-horizontal" action="cari_item_pembelian_bl.php" method="post" role="form">                                            
                                                    <input type="hidden" name="txtnoorder" 
                                                    class="form-control" value="<?php echo $nopesanan; ?>"/>
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pembelian_add_next.php?kd=<?php echo $tampil['id']; ?>&kdsup=<?php echo $cbosupplier; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>	
                        ...
                        <form class="form-horizontal" action="save_pembelian.php" method="post" role="form">
