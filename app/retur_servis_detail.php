...
if(empty($_SESSION['_iduser'])){
    ...
    $hdr = mysqli_query($koneksi, "SELECT h.*, DATE_FORMAT(STR_TO_DATE(h.tanggal,'%Y-%m-%d'),'%d/%m/%Y') AS tgl_fmt,
                                          p.namapelanggan
            ...
            <div class="main-content-inner">
                ...
                <div class="page-content">
                    ...
                    <div class="alert alert-success">
                        <i class="fa fa-check-circle"></i> <strong>Retur servis berhasil disimpan!</strong>
                        No. Retur: <strong><?php echo htmlspecialchars($noretur); ?></strong>
                    </div>
                    <?php endif; ?>
                    <?php if($approved): ?>
                    <div class="alert alert-success">
                        <i class="fa fa-check-circle"></i> <strong>Retur servis berhasil disetujui!</strong> Status diubah menjadi <strong>Selesai</strong>, stok barang sudah dikembalikan.
                    </div>
                    <?php endif; ?>
                        ...
                        <div class="col-xs-12">
                            <div class="widget-box">
                                <div class="widget-header">
                                    <h4 class="widget-title"><i class="fa fa-undo"></i> Detail Retur Servis</h4>
                                    <div class="widget-toolbar">
                                        <?php if($h['status_retur'] == '0'): ?>
                                        <a href="retur_servis_approve.php?noretur=<?php echo urlencode($noretur); ?>"
                                           class="btn btn-sm btn-success"
                                           onclick="return confirm('Setujui retur ini? Stok akan dikembalikan dan status berubah menjadi Selesai.');">
                                            <i class="fa fa-check"></i> Setujui
                                        </a>
                                        <a href="retur_servis_batal.php?noretur=<?php echo urlencode($noretur); ?>"
                                           class="btn btn-sm btn-danger"
                                           onclick="return confirm('Batalkan retur ini? Data akan dihapus permanen.');">
                                            <i class="fa fa-trash"></i> Batal
                                        </a>
                                        <?php endif; ?>
                                        <a href="retur_servis.php" class="btn btn-sm btn-default">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6">
                                                <table class="table table-condensed">
                                                    ...
                                                    <tr><td><strong>No. Service</strong></td><td><?php echo htmlspecialchars($h['no_service']); ?></td></tr>
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-sm-offset-2">
                                                <table class="table table-condensed table-bordered">
                                                    ...
                                                    <tr><td><strong>Total Nilai Retur (Refund)</strong></td><td align="right"><strong><?php echo number_format($h['total_retur'],0,',','.'); ?></strong></td></tr>
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <thead style="background:#5a7a35;color:#fff;">
                                                <tr>
                                                    ...
                                                    <th align="right" width="12%">Harga</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $d['tipe_item']=='barang' ? 'Barang' : 'Jasa'; ?></td>
