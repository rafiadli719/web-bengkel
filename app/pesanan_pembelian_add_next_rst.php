        ...
        if(isset($_POST['btnadd'])) {	
            ...
            if($txtkdbarang<>'') {
                ...
                $cari_kd=mysqli_query($koneksi,"SELECT sum(total) as tot 
                                                ...
                                                WHERE 
                                                no_order='$nopesanan' and user='$user_order'");			
                $tm_cari=mysqli_fetch_array($cari_kd);
                $tot=$tm_cari['tot']; 
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
							...
							<div class="col-xs-12 col-sm-12">
								<div class="widget-box">
									<div class="widget-body">
										<div class="widget-main">	
                                            <div class="row">
                                                <form class="form-horizontal" action="cari_item_pesanan_pembelian.php" method="post" role="form">                                            
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <div class="col-xs-12 col-sm-2">
                                                        <div class="form-group">
                                                            <label class="col-sm-5 control-label no-padding-right" for="form-field-1"> Jumlah : </label>
                                                            <div class="col-sm-7">
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td align="right" width="15%">Harga Pokok</td>
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pesanan_pembelian_add_next.php?kd=<?php echo $tampil['id']; ?>&kdsup=<?php echo $cbosupplier; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>	
                        ...
                        <form class="form-horizontal" action="save_pesanan_pembelian.php" method="post" role="form">
