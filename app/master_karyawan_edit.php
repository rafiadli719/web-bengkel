...
if(empty($_SESSION['_iduser'])){
    ...
    if (!isAdmin()) {
        checkPermissionOrDie('users', 'edit');
    }
...
<head>
    ...
    <meta charset="utf-8" />
    <title>Edit Karyawan - <?php include "../lib/titel.php"; ?></title>
    <meta name="description" content="Edit Data Karyawan" />
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            ...
                            <small><?php echo $karyawan['nama_lengkap']; ?></small>
                        </h1>
                    </div>
                    ...
                    <!-- Info Box -->
                    <div class="info-box">
                        <strong>Kode Karyawan:</strong> <?php echo $karyawan['kode_karyawan']; ?> | 
                        <strong>Dibuat:</strong> <?php echo date('d-m-Y', strtotime($karyawan['created_at'])); ?> | 
                        <strong>Diupdate:</strong> <?php echo date('d-m-Y H:i', strtotime($karyawan['updated_at'])); ?>
                    </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $karyawan['kode_karyawan']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_lengkap" class="form-control" value="<?php echo $karyawan['nama_lengkap']; ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nama Panggilan</label>
                                        <input type="text" name="nama_panggilan" class="form-control" value="<?php echo $karyawan['nama_panggilan']; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telp" class="form-control" value="<?php echo $karyawan['telp']; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Alamat</label>
                                        <textarea name="alamat" class="form-control" rows="3"><?php echo $karyawan['alamat']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="kode_posisi" class="form-control" required>
                                            ...
                                            <?php 
                                            mysqli_data_seek($result_posisi, 0);
                                            while($row = mysqli_fetch_assoc($result_posisi)) { 
                                            ?>
                                                <option value="<?php echo $row['kode_posisi']; ?>" 
                                                    <?php echo ($row['kode_posisi'] == $karyawan['kode_posisi']) ? 'selected' : ''; ?>>
                            ...
                            <div class="row">
                                        ...
                                        <select name="kode_cabang" class="form-control" required>
                                            ...
                                            ?>
                                                <option value="<?php echo $row['kode_cabang']; ?>" 
                                                    <?php echo ($row['kode_cabang'] == $karyawan['kode_cabang']) ? 'selected' : ''; ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_masuk" class="form-control" value="<?php echo $karyawan['tanggal_masuk']; ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="spesialisasi" class="form-control" rows="2"><?php echo $karyawan['spesialisasi']; ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Sertifikat</label>
                                        <textarea name="sertifikat" class="form-control" rows="2"><?php echo $karyawan['sertifikat']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_keluar" class="form-control" value="<?php echo $karyawan['tanggal_keluar'] ?? ''; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
