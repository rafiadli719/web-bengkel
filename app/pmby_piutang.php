<?php
    ...
    // --------------------
        ...
        $sql_query = "SELECT * FROM view_pembayaran_piutang 
                     ...
                     ORDER BY tanggal DESC, no_transaksi DESC 
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <form class="form-horizontal" action="" method="post" role="form">
                                                <?php include "_template/_pmby_piutang_cari.php"; ?>
                                            </form>
                                        </div>
									</div>
								</div>	
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pmby_piutang_detail.php?snotrx=<?php echo $tampil['no_transaksi']; ?>">Detail</a>
                                                        </li>
                                                        <li>
