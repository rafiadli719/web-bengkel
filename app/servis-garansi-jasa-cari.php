<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {
            ...
            echo"<script>window.location=('servis-garansi-jasa-cari.php?snoserv=" . urlencode($no_service) . "&_key=" . urlencode($txtkey) . "&_cari=" . urlencode($cbocari) . "&_urut=" . urlencode($cbourut) . "&_flt=asc');</script>";
        }
		...
		if(isset($_POST['btndesc'])) {
			...
			$cbocari= $_POST['cbocari'];
			$cbourut= $_POST['cbourut'];
            echo"<script>window.location=('servis-garansi-jasa-cari.php?snoserv=" . urlencode($no_service) . "&_key=" . urlencode($txtkey) . "&_cari=" . urlencode($cbocari) . "&_urut=" . urlencode($cbourut) . "&_flt=desc');</script>";
        }
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Cari Item Paket</li>
						</ul><!-- /.breadcrumb -->
					</div>
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <form class="form-horizontal" action="" method="post" role="form">
                                                ...
                                                <?php include "_template/_cari-jasa-service.php"; ?>
                                            </form>
                                        </div>
									</div>
								</div>	
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td width="10%">Kode WO</td>
                                            <td width="85%">Nama WO</td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php 
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="servis-garansi.php?snoserv=<?php echo $no_service; ?>&kdjasa=<?php echo $tampil['kode_wo']; ?>&kd=<?php echo $kd; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                                                                    
                                            </td>														
