...
<html lang="en">
	<head>
		...
		<meta name="description" content="Master Jenis Motor" />
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Jenis Motor</li>
						</ul>
					</div>
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="input-group">
														<input type="text" id="search-jenis" class="form-control" placeholder="Cari jenis motor..." />
								...
								<div class="widget-box">
									<div class="widget-header">
										<h4 class="widget-title">
											...
											Action Menu - Master Jenis Motor
										</h4>
									</div>
									<div class="widget-body">
										<div class="widget-main">
											<div class="row">
												<div class="col-sm-12">
													<a href="master_jenis_motor_add.php" class="btn btn-primary btn-sm">
									...
									<table id="dynamic-table" class="table table-striped table-bordered table-hover">
										...
										<?php
											...
											$sql = mysqli_query($koneksi,"SELECT
                                                                        * FROM tbjenis_motor ORDER BY jenis ASC");
										...
										<tr <?php echo $row_class; ?>>
											...
											<td class="center">
												<a class="green" data-rel="tooltip" title="Edit"
													href="master_jenis_motor_edit.php?kd=<?php echo $tampil['kd']?>">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>&nbsp;
												<?php if ($status == '1') { ?>
												<a class="orange" data-rel="tooltip" title="Nonaktifkan"
													href="master_jenis_motor_del.php?kd=<?php echo $tampil['kd']?>&action=deactivate"
													onclick="return confirm('Jenis Motor akan dinonaktifkan. Lanjutkan?')">
													<i class="ace-icon fa fa-ban bigger-130"></i>
												</a>
												<?php } else { ?>
												<a class="blue" data-rel="tooltip" title="Aktifkan"
													href="master_jenis_motor_del.php?kd=<?php echo $tampil['kd']?>&action=activate"
													onclick="return confirm('Jenis Motor akan diaktifkan. Lanjutkan?')">
