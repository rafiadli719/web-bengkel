<?php
    ...
    // --------------------
		...
		$cari_kd=mysqli_query($koneksi,"SELECT 
                                        ...
                                        tanggal, jam, no_pelanggan, no_polisi, status_servis 
                                        FROM tblservice 
        ...
        if(isset($_POST['btnupdatestatus'])) {
            ...
            echo"<script>window.location=('servis-input-reguler-rst.php?snoserv=$no_service&kd=$txtcaribrg&kdjasa=$txtcarisrv&kdwo=$txtcariwo');
            </script>";
        }
        ...
        if(isset($_POST['btnaddworkorder'])) {
            ...
            echo"<script>window.location=('servis-input-reguler-rst.php?snoserv=$no_service&kd=$txtcaribrg&kdjasa=$txtcarisrv&kdwo=');
            </script>";
        }
		...
		if(isset($_POST['btnaddkeluhan'])) {				
            ...
            // Preserve current values in redirect for keluhan
            echo"<script>window.location=('servis-input-reguler-rst.php?snoserv=$no_service&kd=$txtcaribrg&kdjasa=$txtcarisrv&kdwo=$txtcariwo');
            </script>";
        }
                        ...
                        <form class="form-horizontal" action="" method="post" role="form">                                            
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-7">
                                    <?php include "_template/_servis_add_header.php"; ?>                            
                                </div>
                                <div class="col-xs-12 col-sm-5">
                                    <?php include "_template/_servis_add_header_kanan.php"; ?>                            
                                </div>    
                            </div>
