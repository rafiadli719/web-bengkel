...
if (empty($_SESSION['_iduser'])) {
    ...
    // Include konfigurasi Accurate API (sesuai pola yang berhasil)
                        ...
                        <?php if (isset($_SESSION['accurate_status'])): ?>
                            <div class="alert alert-<?php echo $_SESSION['accurate_status'] == 'connected' ? 'success' : 'warning'; ?> alert-dismissible">
                                ...
                                <?php if ($_SESSION['accurate_status'] == 'connected'): ?>
                                    <i class="fa fa-check-circle"></i> ✅ Terhubung - Perubahan akan disimpan lokal dan membuat kategori baru di Accurate Online
                                <?php else: ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-9">
                                            <div class="alert alert-info">
                                                ...
                                                Perubahan data kategori akan disimpan ke database lokal. 
                                                <?php if (isset($_SESSION['accurate_status']) && $_SESSION['accurate_status'] == 'connected'): ?>
                                                    Sistem akan otomatis membuat kategori baru di Accurate Online dengan kode sesuai nama kategori.
                                                <?php else: ?>
        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                $('form').on('submit', function(e) {
                    ...
                    var confirmMessage = 'Apakah Anda yakin ingin menyimpan perubahan kategori ini?\n\n' +
                                       'Kode: ' + kode + '\n' +
                                       'Nama: ' + nama + '\n\n' +
                                       'Perubahan akan disimpan ke database lokal';
                    
                    <?php if (isset($_SESSION['accurate_status']) && $_SESSION['accurate_status'] == 'connected'): ?>
                        confirmMessage += ' dan akan membuat kategori baru di Accurate Online.';
                    <?php else: ?>
