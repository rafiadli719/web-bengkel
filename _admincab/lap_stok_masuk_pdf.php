<?php
    ...
    $nama_file="Laporan Penyesuaian Stok (Item Masuk) ".$tgl_pilih_dari." s/d ".$tgl_pilih_sampai.".pdf";
	...
	$html = '<table style="margin: 0 0pt; width: 100%; border-collapse:collapse;" border="0">
                <tr>
                    <td align="center"><b>Laporan Penyesuaian Stok (Item Masuk) <br>Periode '.$tgl_pilih_dari.' s/d '.$tgl_pilih_sampai.'</b></td>
                </tr>
            </table>
            <br>
