                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td align="right" width="12%">Harga</td>
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="stok_masuk_edit_item.php?sid=<?php echo $tampil['id']; ?>&stgl=<?php echo $tgl_pilih; ?>">Edit Item</a>
                                                        </li>
                                                        <li>
                                                            <a href="stok_masuk_hapus_item.php?sid=<?php echo $tampil['id']; ?>&stgl=<?php echo $tgl_pilih; ?>" 
