    ...
    <div class="col-xs-8 col-sm-3">
        ...
        <div class="row">
            <div class="col-xs-8 col-sm-12">    
                ...
                <?php
                    $q = mysqli_query($koneksi,"select id, cari FROM tbcari where tipe='13' order by id asc");
    ...
    <div class="col-xs-8 col-sm-3">
        ...
        <div class="row">
            <div class="col-xs-8 col-sm-12">    
                ...
                <?php
                    $q = mysqli_query($koneksi,"select id, urut FROM tburut where tipe='13' order by id asc");
                    while ($row1 = mysqli_fetch_array($q)){
                        $k_id           = $row1['id'];
                        $k_opis         = $row1['urut'];
                ?>
    ...
    <div class="col-xs-8 col-sm-3">
        ...
        <div class="row">
            <div class="col-xs-8 col-sm-6">    
                ...
                <i class="ace-icon fa fa-arrow-up icon-on-right"></i> Asc
                </button>
            </div>
            <div class="col-xs-8 col-sm-6">    
                <button class="btn <?php echo $tipebtn2; ?> btn-block" type="submit" 
                id="btndesc" name="btndesc">
                <i class="ace-icon fa fa-arrow-down icon-on-right"></i> Desc
                </button>
            </div>
        </div>
    </div>
