        ...
        <div class="widget-main">
            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-sm-8">
                    ...
                    <select class="form-control" name="cbokepala2" id="cbokepala2" onchange="autoFillKepalaPercentage()">
                        <option value="">- Pilih Kepala Mekanik -</option>
                        <?php
                            if(isset($koneksi)) {
                                try {
