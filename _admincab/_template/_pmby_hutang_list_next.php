                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-default">
                                                                    <li>
                                                                        ...
                                                                        nobyr=<?php echo $tampil['no_transaksi']; ?>&nobl=<?php echo $tampil['no_pembelian']; ?>&jml=<?php echo $kekurangan; ?>&stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $no_supplier; ?>">Edit Jumlah Bayar</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="hapus_bayar_hutang.php?
                                                                        nobyr=<?php echo $tampil['no_transaksi']; ?>
                                                                        &nobl=<?php echo $tampil['no_pembelian']; ?>&stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $no_supplier; ?>">Hapus Faktur Pembelian</a>
                                                                    </li>
                                                                </ul>
                                                            </div><!-- /.btn-group -->                                                                                                                
                                                        </td>
