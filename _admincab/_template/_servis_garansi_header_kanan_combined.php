<?php
// File: _servis_garansi_header_kanan_combined.php
...
$km_skr = '';
$km_berikut = '';
$status_jemput = '0'; // Default ditinggal
                    ...
                    <div class="row">
                        <div class="col-xs-8 col-sm-12">
                            <select name="status_jemput" id="status_jemput" class="form-control" onchange="updateJenisService()">
                                <option value="0" <?php echo (isset($status_jemput) && $status_jemput == '0') ? 'selected' : 'selected'; ?>>Ditinggal</option>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12">
                    <div class="alert alert-success" style="margin-bottom: 15px;">
                        ...
                        <small>Input keluhan dan work order untuk servis garansi</small>
                        <br><span class="label label-success">SERVIS GARANSI</span> - Sebagian atau seluruh biaya ditanggung garansi
                    </div>
                </div>
            </div>
                    ...
                    <div class="widget-box widget-color-green" style="margin-bottom: 15px;">
                        <div class="widget-header widget-header-small">
                            <h5 class="widget-title">
                                <i class="ace-icon fa fa-shield"></i>
                                Input Keluhan & Work Order Garansi
                            </h5>
                        </div>
                        <div class="widget-body">
                                ...
                                <div class="row" style="margin-bottom: 20px;">
                                    <div class="col-xs-12 col-sm-12">
                                        <h6 class="header orange smaller" style="margin-top: 0;">
                                            <i class="ace-icon fa fa-exclamation-triangle"></i> Input Keluhan Garansi
                                        </h6>
                                        <table class="table table-bordered" style="margin-bottom: 15px;">
                                            <tr>
                                                <td width="70%">
                                                    ...
                                                    placeholder="Masukkan keluhan garansi" autocomplete="off" />
                                                </td>
                                                <td width="30%">
                                                    <label>&nbsp;</label><br>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12">
                                        <h6 class="header blue smaller" style="margin-top: 0;">
                                            <i class="ace-icon fa fa-cogs"></i> Input Work Order Garansi
                                        </h6>
                                        <table class="table table-bordered" style="margin-bottom: 15px;">
                                            <tr>
                                                <td width="70%">
                            ...
                            <div class="widget-main" style="padding: 15px;">
                                <div class="alert alert-success" style="margin-bottom: 15px; padding: 10px;">
                                    <div class="row">
                                        <div class="col-xs-8">
                                            ...
                                            <br><span class="label label-success">SERVIS GARANSI</span>
                                        </div>
                                ...
                                <div style="max-height: 300px; overflow-y: auto;">
                                    ...
                                    <div class="alert alert-info" style="margin-bottom: 0; padding: 10px;">
                                        ...
                                        <br><small>Tambahkan keluhan atau work order garansi di atas</small>
                                    </div>
                                    <?php } ?>
                                </div>
                            </div>
