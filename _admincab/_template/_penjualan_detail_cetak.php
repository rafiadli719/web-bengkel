                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="penjualan_edit_item.php?kd=<?php echo $tampil['id']; ?>&kdsup=<?php echo $cbosupplier; ?>">Edit Item</a>
                                                        </li>
                                                        <li>
                                                            <a href="penjualan_hapus_item.php?kd=<?php echo $tampil['id']; ?>&kdsup=<?php echo $cbosupplier; ?>">Hapus Item</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>	
