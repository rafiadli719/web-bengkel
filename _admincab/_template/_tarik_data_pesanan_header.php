<div class="row">
    <div class="col-xs-12 col-sm-4">
        <div class="form-group">
            <label class="col-sm-5 control-label no-padding-right" for="txtnojl"> No. Penjualan :</label>									
            <div class="col-sm-7">
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-8">
        ...
        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Dari Cabang : </label>									
        <div class="col-sm-4">
