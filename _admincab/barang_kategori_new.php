												...
												<?php 
													$no = 0 ;
														$sql = mysqli_query($koneksi,"SELECT 
                                                                                * FROM tblitemjenis ORDER BY status DESC, namajenis ASC");
...
<?php
															...
															$ikut_margin_jenis = $tampil['ikut_margin_jenis'] ?? '1';
															$margin_sesuai_jenis = ($ikut_margin_jenis == '1') ? 'YA' : 'TIDAK';
															$margin_sesuai_jenis_class = ($ikut_margin_jenis == '1') ? 'label-success' : 'label-warning';
															
															// Handle margin kategori
															$margin_kategori = $tampil['margin_khusus'] ?? '';
															if ($margin_kategori == '' || $margin_kategori == null) {
																$margin_kategori = '-';
															} else {
																$margin_kategori = number_format($margin_kategori, 0) . '%';
															}
														...
														<tr <?php echo $row_class; ?>>
															...
															<td class="center">
																<span class="label <?php echo $margin_sesuai_jenis_class; ?>"><?php echo $margin_sesuai_jenis; ?></span>
															</td>
															<td class="center"><?php echo $margin_kategori?></td>
															<td class="center">
																<span class="label <?php echo $status_class; ?>"><?php echo $status_text; ?></span>
															</td>																								
															<td class="center">																							
																<a class="green" data-rel="tooltip" title="Edit" 
																	href="barang_kategori_edit_new.php?kd=<?php echo $tampil['id']?>">
...
<?php } else { ?>
																<a class="blue" data-rel="tooltip" title="Aktifkan" 
																	href="barang_kategori_del_new.php?kd=<?php echo $tampil['id']?>&action=activate" 
