<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {	
            ...
            echo"<script>window.location=('pesanan_penjualan_add_pelanggan_cari.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
            echo"<script>window.location=('pesanan_penjualan_add_pelanggan_cari.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";
        }
								...
								<div class="widget-box">
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">
											...
											Cari Pelanggan - Pesanan Penjualan
										</h4>
                                        <div class="widget-toolbar">
                                            <span class="label label-info arrowed-in arrowed-in-right">Customer Search</span>
                                        </div>
									</div>
							...
							<div class="col-xs-12">
                                <div class="widget-box">
                                    <div class="widget-header widget-header-green widget-header-flat">
                                        ...
                                        <div class="widget-toolbar">
                                            <a href="pesanan_penjualan_add.php" class="btn btn-xs btn-light">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                ?>
                                                    <tr>
                                                        <td class="center">
                                                            <div class="btn-group">
                                                                <a href="pesanan_penjualan_add_rst.php?stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $tampil['nopelanggan']; ?>&ssales=<?php echo $cbosales; ?>&kd=<?php echo $noitem; ?>" 
                                                                   class="btn btn-xs btn-success" title="Pilih Pelanggan">
                                                        ...
                                                        <td>
                                                            <strong class="text-primary"><?php echo $tampil['nopelanggan']; ?></strong>
                                                        </td>														
                                                        <td>
                                                        ...
                                                        <td>
                                                            <span class="text-muted"><?php echo $tampil['alamat']; ?></span>
                                                        </td>														                                                                                                                
                                                        <td>
                                                            <span class="label label-sm label-grey"><?php echo $tampil['kota']; ?></span>
                                                        </td>														                                                                                                                
                                                        <td>
                                                            <i class="ace-icon fa fa-phone text-success"></i>
                                                            <?php echo $tampil['telephone']; ?>
                                                        </td>														                                                                                                                                                                                                        
                                                    </tr>
