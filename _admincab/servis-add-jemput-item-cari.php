<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {	
            ...
            echo"<script>window.location=('servis-add-jemput-item-cari.php?snoserv=$no_service&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
            echo"<script>window.location=('servis-add-jemput-item-cari.php?snoserv=$no_service&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";
        }
                                            ...
                                            <td bgcolor="<?php echo $bgcolor; ?>" class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="servis-input-reguler-jemput-rst.php?snoserv=<?php echo $no_service; ?>&kd=<?php echo $tampil['noitem']; ?>&kdjasa=<?php echo $kdjasa; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                                                                    
                                            </td>														
