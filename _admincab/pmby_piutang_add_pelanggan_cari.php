<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {	
            ...
            echo"<script>window.location=('pmby_piutang_add_pelanggan_cari.php?stgl=$tgl_pilih&ssup=$nopelanggan&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
            echo"<script>window.location=('pmby_piutang_add_pelanggan_cari.php?stgl=$tgl_pilih&ssup=$nopelanggan&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";
        }
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pmby_piutang_add_rst.php?stgl=<?php echo $tgl_pilih; ?>&ssup=<?php echo $tampil['nopelanggan']; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                                                                    
                                            </td>														
