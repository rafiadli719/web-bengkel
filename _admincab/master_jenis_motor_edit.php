    ...
    // --------------------
		...
		if(isset($_POST['submit'])){
			...
			if(empty($jenis)) {
				...
				// Cek duplikasi jenis (kecuali data sendiri)
				$cek_jenis = mysqli_query($koneksi, "SELECT kd FROM tbjenis_motor WHERE jenis='$jenis' AND kd != '$kd'");
				if(mysqli_num_rows($cek_jenis) > 0) {
					$pesan = "JENIS MOTOR harus diganti";
				} else {
					// Update data
					$sql = "UPDATE tbjenis_motor SET
							jenis = '$jenis',
							keterangan = '$keterangan'
							WHERE kd = '$kd'";

					if(mysqli_query($koneksi, $sql)) {
						echo "<script>alert('Data berhasil diperbarui'); window.location='master_jenis_motor.php';</script>";
					} else {
...
<html lang="en">
	<head>
		...
		<meta name="description" content="Edit Master Jenis Motor" />
	...
	<body class="no-skin">
							...
							<div class="col-xs-12">
								<div class="widget-box">
									<div class="widget-header">
										<h4 class="widget-title">Edit Master Jenis Motor</h4>
										...
										<div class="widget-main">
											...
											<div class="alert alert-info">
												...
												<table class="table table-bordered">
													<tr>
														<td width="30%"><strong>Jenis Motor:</strong></td>
														<td><?php echo $data_edit['jenis']; ?></td>
													</tr>
													<tr>
											...
											<form method="post" class="form-horizontal" role="form">
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="jenis">
														Edit Jenis Motor Menjadi <span class="red">*</span>
													</label>
													<div class="col-sm-9">
		...
		<script type="text/javascript">
			jQuery(function($) {
				// Transform jenis to uppercase dan hapus spasi
