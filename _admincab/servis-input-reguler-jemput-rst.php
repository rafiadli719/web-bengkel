<?php
    ...
    // --------------------
        ...
        if(isset($_POST['btnupdatestatus'])) {
            ...
            echo"<script>window.location=('servis-input-reguler-jemput-rst.php?snoserv=$no_service&kd=$txtcaribrg&kdjasa=$txtcarisrv&kdwo=$txtcariwo');
            </script>";
        }
        ...
        if(isset($_POST['btnaddworkorder'])) {
            ...
            echo"<script>window.location=('servis-input-reguler-jemput-rst.php?snoserv=$no_service&kd=$txtcaribrg&kdjasa=$txtcarisrv&kdwo=');
            </script>";
        }
		...
		if(isset($_POST['btncari'])) {				
            ...
            // == Total dari Item & Waktu Service ==============
                ...
                // == Total dari Item Barang ==============
                    ...
                    $cbocari="";
                    $cbourut="35";
                    echo"<script>window.location=('servis-add-jemput-item-cari.php?&snoserv=$no_service&_key=$txtcaribrg&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
                }                
        }            
        ...
        if(isset($_POST['btnsimpan'])) {	
            ...
            echo"<script>window.alert('Data Service Jemput Berhasil disimpan!');
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Input Servis Jemput</li>
						</ul><!-- /.breadcrumb -->
					</div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-7">
                                    ...
                                    try {
                                        ...
                                        ob_end_clean();
                                        echo '<div class="alert alert-danger">Error loading template: ' . $e->getMessage() . '</div>';
                                    }
                                    ?>                            
                                </div>
...
<!-- JavaScript Functions for SP Motor and Cetak Nota -->
<script type="text/javascript">
function cetakNota() {
