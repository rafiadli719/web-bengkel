<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {	
            ...
            echo"<script>window.location=('paket_add_jasa_cari_detail.php?kdwo=$kdwo&_keyjasa=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";            
        }
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <form class="form-horizontal" action="" method="post" role="form">        
                                                <input type="hidden" name="txtkdwo"  class="form-control" value="<?php echo $kdwo; ?>"/>                        
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="paket_editd.php?kdwo=<?php echo $kdwo; ?>&kd=<?php echo $kdbrg; ?>&kdjasa=<?php echo $tampil['noitem']; ?>">Pilih</a>
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                                                                    
                                            </td>														
