				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="barang_rak.php">Rak Barang</a>
							</li>                                                                                    
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" action="barang_rak_edit_proses.php" method="post">
									<input type="hidden" name="txtid"  class="form-control" value="<?php echo $kd; ?>"/>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Rak Barang </label>
										<div class="col-sm-9">
