				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="lembur_pengajuan.php">Lembur</a>
							</li>
							<li>
								<a href="lembur_pengajuan_manual.php">Pengajuan Lembur Manual</a>
							</li>
					...
					<div class="page-content">
                        ...
                        <div class="row">
							<div class="col-xs-5">                        
                                <table width="100%">
                                    <tr>
                                        <td width="30%" align="right">No. Transaksi</td>
                                        <td width="5%" align="center">:</td>
                                        <td width="55%">
                                            <input type="text" id="txtkd" name="txtkd" 
                                    ...
                                    <tr>
                                        <td width="30%" align="right">No. Pesanan</td>
                                        <td width="5%" align="center">:</td>
                                        <td width="55%">
