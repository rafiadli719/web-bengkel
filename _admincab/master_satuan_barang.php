...
<html lang="en">
	<head>
		...
		<meta name="description" content="Master Satuan Barang" />
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="input-group">
														<input type="text" id="search-satuan" class="form-control" placeholder="Cari satuan atau nama satuan..." />
								...
								<div class="widget-box">
									<div class="widget-header">
										<h4 class="widget-title">
											...
											Action Menu - Master Satuan Barang
										</h4>
									</div>
									<div class="widget-body">
										<div class="widget-main">
											<div class="row">
												<div class="col-sm-12">
													<a href="master_satuan_barang_add.php" class="btn btn-primary btn-sm">
									...
									<table id="dynamic-table" class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												...
												<th class="center" width="15%">Kode Satuan</th>
										...
										<?php
											...
											$sql = mysqli_query($koneksi,"SELECT
                                                                        * FROM tblitemsatuan ORDER BY satuan ASC");
										...
										<tr <?php echo $row_class; ?>>
											...
											<td class="center"><strong><?php echo $tampil['satuan']?></strong></td>
											<td><?php echo $tampil['namasatuan']?></td>
											...
											<td class="center">
												<a class="green" data-rel="tooltip" title="Edit"
													href="master_satuan_barang_edit.php?kd=<?php echo $tampil['id']?>">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>&nbsp;
												<?php if ($status == '1') { ?>
												<a class="orange" data-rel="tooltip" title="Nonaktifkan"
													href="master_satuan_barang_del.php?kd=<?php echo $tampil['id']?>&action=deactivate"
													onclick="return confirm('Satuan Barang akan dinonaktifkan. Lanjutkan?')">
													<i class="ace-icon fa fa-ban bigger-130"></i>
												</a>
												<?php } else { ?>
												<a class="blue" data-rel="tooltip" title="Aktifkan"
													href="master_satuan_barang_del.php?kd=<?php echo $tampil['id']?>&action=activate"
													onclick="return confirm('Satuan Barang akan diaktifkan. Lanjutkan?')">
