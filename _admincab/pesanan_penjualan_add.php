    ...
    // --------------------
		...
		if(isset($_POST['btncari_pelanggan'])) {
            ...
            if($tot_cari=='1') {
                ...
                $cbocari="";
                $cbourut="23";
                echo"<script>window.location=('pesanan_penjualan_add_pelanggan_cari.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&_key=$nopelanggan&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";                
            }
		...
		if(isset($_POST['btncari'])) {				
            ...
            if($tot_cari=='1') {
                ...
                echo"<script>
                    ...
                    window.location=('pesanan_penjualan_add_item_cari.php?stgl=$tgl_pilih&ssup=$nopelanggan&ssales=$cbosales&_key=$txtcaribrg&_cari=$cbocari&_urut=$cbourut&_flt=asc');
                </script>";
            }
        ...
        if(isset($_POST['btnadd'])) {	
            include "proses-add-detail/pesanan-penjualan.php"; 
        }     
        ...
        if(isset($_POST['btnsimpan'])) {
            ...
            $total_qty_order=$tm_cari['tot_qty_jual'];                                 
                ...
                echo"<script>window.location=('pesanan_penjualan_cetak.php?nopesanan=$LastID');</script>";        
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <input type="hidden" name="active_tab" id="active_tab" value="order-details"/>
						<div class="row">
							<div class="col-xs-12">
								<div class="widget-box">
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">
											...
											Pesanan Penjualan #<?php echo $LastID; ?>
										</h4>
                                        <div class="widget-toolbar">
                                            <span class="label label-success arrowed-in arrowed-in-right">Order Details</span>
                                        </div>
									</div>
												...
												<div class="tab-content">
														...
														<div class="row">
															<div class="col-xs-12">
																<div class="padding-18">
																	<?php include "_template/_pesanan_penjualan_header.php"; ?>
																	...
																	<div class="row">
																		<div class="col-xs-12">
																			<div class="form-group">
																				<label class="col-sm-2 control-label no-padding-right"> Jml. Pesanan </label>
																				<div class="col-sm-3">
																			...
																			<div class="form-group">
																				...
																				<div class="col-sm-10">
																					<textarea class="form-control" id="txtnote" name="txtnote" rows="3" placeholder="Keterangan pesanan..."></textarea>
																				</div>
																			</div>
																		</div>
																	</div>
													...
													<div id="order-items" class="tab-pane fade">
														<div class="row">
															<div class="col-xs-12">
																<div class="padding-18">
																	<?php include "_template/_pesanan_penjualan_detail.php"; ?>
																</div>
															</div>
														</div>
													</div>
														...
														<div class="row">
															<div class="col-xs-12">
																<div class="padding-18">
																	...
																	<?php include "_template/_pesanan_penjualan_total.php"; ?>
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				// Also restore when form actions occur
				$(document).ready(function() {
					// Check URL parameters for tab indication
