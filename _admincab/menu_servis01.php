				<ul class="nav nav-list">
						...
						<ul class="submenu">
							<li class="">
								...
								<ul class="submenu">
									...
									<li class="">
										<a href="workorder-motor-mapping.php">
											<i class="menu-icon fa fa-caret-right"></i>
											WO - Jenis Motor Mapping
										</a>
										<b class="arrow"></b>
									</li>
									<li class="">
										<a href="jasa-motor-mapping.php">
											<i class="menu-icon fa fa-caret-right"></i>
									...
									<li class="">
										<a href="master-barang-custom.php">
											<i class="menu-icon fa fa-caret-right"></i>
									...
									<li class="">
										<a href="master-temuan-mapping.php">
											<i class="menu-icon fa fa-caret-right"></i>
											Temuan - Part Mapping
										</a>
										<b class="arrow"></b>
									...
									<li class="">
										<a href="master-temuan-mapping-jasa.php">
											<i class="menu-icon fa fa-caret-right"></i>
											Temuan - Jasa Mapping
										</a>
										<b class="arrow"></b>
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="penyesuaian-stok-otomatis.php">
									<i class="menu-icon fa fa-caret-right"></i>
									Otomatis
								</a>
								<b class="arrow"></b>
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="lap_pesanan_pembelian.php">
									<i class="menu-icon fa fa-caret-right"></i>
									Pesanan Pembelian
								</a>
								<b class="arrow"></b>
