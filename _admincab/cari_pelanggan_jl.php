<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {				
			...
			echo"<script>window.location=('cari_pelanggan_jl_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc&stgl=<?php echo $txttgljl; ?>&ssales=<?php echo $cbosales; ?>&suser=<?php echo $txtuser; ?>');</script>";            
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			echo"<script>window.location=('cari_pelanggan_jl_rst.php?_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc&stgl=<?php echo $txttgljl; ?>&ssales=<?php echo $cbosales; ?>&suser=<?php echo $txtuser; ?>');</script>";            
        }
?>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Cari Data Pelanggan</li>
						</ul><!-- /.breadcrumb -->
					</div>
...
<input type="hidden" name="id-date-picker-1" 
                                                    class="form-control" value="<?php echo $txttgljl; ?>"/>
                                                    <input type="hidden" name="cbosales" 
                                                    class="form-control" value="<?php echo $cbosales; ?>"/>
                                                    <input type="hidden" name="txtuser" 
                                                    class="form-control" value="<?php echo $txtuser; ?>"/>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, cari FROM tbcari where tipe='5' order by id asc");
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
                                                        ...
                                                        <?php
                                                            $q = mysqli_query($koneksi,"select id, urut FROM tburut where tipe='5' order by id asc");
                                                            while ($row1 = mysqli_fetch_array($q)){
                                                                $k_id           = $row1['id'];
                                                                $k_opis         = $row1['urut'];
                                                        ?>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="center" width="10%">Kota</td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="save_penjualan_h.php?kdpel=<?php echo $tampil['nopelanggan']; ?>&stgl=<?php echo $txttgljl; ?>&suser=<?php echo $txtuser; ?>&ssales=<?php echo $cbosales; ?>">Pilih</a>                                                        
                                                        </li>
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
                                            </td>														
                                            ...
                                            <td class="center"><?php echo $tampil['kota']?></td>														                                                                                                                														                                                                                                                                                                        
