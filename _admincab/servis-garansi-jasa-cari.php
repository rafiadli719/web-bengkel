<?php
    ...
    // end ===========
		...
		if(isset($_POST['btnasc'])) {	
            ...
            echo"<script>window.location=('servis-garansi-jasa-cari.php?snoserv=$no_service&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=asc');</script>";
        }
		...
		if(isset($_POST['btndesc'])) {				
			...
			$cbocari= $_POST['cbocari'];	
			$cbourut= $_POST['cbourut'];
            echo"<script>window.location=('servis-garansi-jasa-cari.php?snoserv=$no_service&_key=$txtkey&_cari=$cbocari&_urut=$cbourut&_flt=desc');</script>";
        }
