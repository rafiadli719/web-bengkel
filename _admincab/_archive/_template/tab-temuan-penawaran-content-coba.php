...
<div class="temuan-redesign-container">
    ...
    <!-- Sub-Tab Navigation -->
    <div class="temuan-subtabs">
        <button type="button" class="temuan-subtab active" data-target="tab-input">
            <i class="fa fa-plus-circle"></i>
            Input Temuan
        </button>
        <button type="button" class="temuan-subtab" data-target="tab-pending">
    ...
    <!-- ========================================== -->
    <div id="tab-input" class="temuan-tab-content active">
                ...
                <form id="form-input-temuan-v2" class="simple-form" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="keluhan_id" id="keluhan_id_v2" class="form-control" required>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label>Temuan <span style="color: var(--danger-red);">*</span></label>
                            <div style="display: flex; gap: 8px;">
                                <input type="text" id="nama_temuan_display_v2" class="form-control"
                                       placeholder="Ketik atau pilih temuan..." style="flex: 1;">
                                <button type="button" class="btn-primary-soft" onclick="$('#modalSearchTemuan').modal('show');">
                    ...
                    <!-- Row 3: Urgensi & Jenis (Side by Side) -->
                    <div class="form-row">
                        <div class="form-group">
                            <label>Urgensi</label>
                            <select name="tingkat_urgensi" id="tingkat_urgensi_v2" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_perbaikan" id="jenis_perbaikan_v2" class="form-control"
                    ...
                    <!-- Area Penawaran Part (Hidden by default) -->
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            ...
                            <div style="display: flex; gap: 8px;">
                                <button type="button" class="btn-primary-soft" style="padding: 6px 12px; font-size: 12px;"
                                        onclick="$('#modalFastMovesV2').modal('show');">
                                    <i class="fa fa-bolt"></i> Fast Moves
                                </button>
                                <button type="button" style="padding: 6px 12px; font-size: 12px; background: var(--warning-orange); color: white; border: none; border-radius: 6px; cursor: pointer;"
    ...
    <!-- TAB 2: Pending Items -->
    <!-- ========================================== -->
    <div id="tab-pending" class="temuan-tab-content">
        <?php
        // Query pending items
                ...
                <div class="pending-card-right">
                    ...
                    <div class="pending-card-actions">
                        <form method="POST" style="display:inline;">
                            <input type="hidden" name="txtnosrv" value="<?= $no_service ?>">
                            <input type="hidden" name="pending_item_id" value="<?= $pending['id'] ?>">
                            <button type="submit" name="btnapprove_wo_item" class="btn-action approve"
                                    onclick="return confirm('Setujui item ini?');" title="Setujui">
        ...
        <div class="temuan-accordion">
            <div class="temuan-accordion-header" onclick="toggleAccordionV2(this)">
                ...
                <div class="temuan-accordion-meta">
                    ...
                    <small><i class="fa fa-shopping-cart"></i> <?= $temuan['total_penawaran'] ?> part</small>
                    <?php endif; ?>
            ...
            <div class="temuan-accordion-body">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div>
                        ...
                        <?php else: ?>
                        <div style="padding: 20px; text-align: center; color: var(--success-green); font-size: 13px;">
                            <i class="fa fa-check"></i> Hanya perlu setting/servis
                        </div>
                        <?php
                            endif;
                        endif;
                        ...
                        <div class="summary-stats">
                            <div class="summary-stat">
                                <small>Pending</small>
                                <strong class="pending"><?= $temuan['pending_count'] ?></strong>
                            </div>
                            <div class="summary-stat">
                                <small>Disetujui</small>
                                <strong class="approved"><?= $temuan['approved_count'] ?></strong>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
...
<div class="modal fade" id="modalRejectItemV2" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form method="POST">
                <input type="hidden" name="txtnosrv" value="<?= $no_service ?>">
                <input type="hidden" name="pending_item_id" id="reject_item_id_v2" value="">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan_reject" class="form-control" rows="2"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Batal</button>
                    <button type="submit" name="btnreject_wo_item" class="btn btn-danger btn-sm">Tolak</button>
                </div>
            </form>
        </div>
    </div>
...
function togglePartSuggestionV2(value) {
    var area = document.getElementById('area-penawaran-part-v2');
...
function hitungTotalPenawaranV2() {
    var h = parseInt(document.getElementById('harga_satuan_penawaran_v2').value || 0);
    var q = parseInt(document.getElementById('quantity_penawaran_v2').value || 1);
    var total = h * q;
    document.getElementById('total_penawaran_display_v2').value = 'Rp ' + total.toLocaleString('id-ID');
}

// Event listeners for penawaran calculation
document.getElementById('harga_satuan_penawaran_v2').addEventListener('input', hitungTotalPenawaranV2);
document.getElementById('quantity_penawaran_v2').addEventListener('input', hitungTotalPenawaranV2);
...
function addMoreParts(temuanId) {
    if(typeof jQuery !== 'undefined' && jQuery('#modalAddPartToTemuan').length) {
        ...
        alert('Tambah part untuk temuan ID: ' + temuanId);
    }
}
