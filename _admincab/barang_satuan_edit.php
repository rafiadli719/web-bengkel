...
if (empty($_SESSION['_iduser'])) {
    ...
    // Get data satuan untuk edit
    $kd = $_GET['kd'];
    $cari_kd = mysqli_query($koneksi, "SELECT satuan, namasatuan FROM tblitemsatuan WHERE id='$kd'");
    $tm_cari = mysqli_fetch_array($cari_kd);    
    $jenis = $tm_cari['satuan'];
    $namajenis = $tm_cari['namasatuan'];
}
?>
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="barang_satuan.php">Satuan Barang</a>
                            </li>                                                                                    
                    ...
                    <div class="page-content">
                        ...
                        <?php if (isset($_SESSION['accurate_status'])): ?>
                            <div class="alert alert-<?php echo $_SESSION['accurate_status'] == 'connected' ? 'success' : 'warning'; ?> alert-dismissible">
                                ...
                                <?php if ($_SESSION['accurate_status'] == 'connected'): ?>
                                    <i class="fa fa-check-circle"></i> ✅ Terhubung - Perubahan akan disimpan lokal dan membuat unit baru di Accurate Online
                                <?php else: ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form-horizontal" action="barang_satuan_edit_proses.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-9">
                                            <div class="alert alert-info">
                                                ...
                                                Perubahan data satuan akan disimpan ke database lokal. 
                                                <?php if (isset($_SESSION['accurate_status']) && $_SESSION['accurate_status'] == 'connected'): ?>
                                                    Sistem akan otomatis membuat unit baru di Accurate Online dengan nama sesuai satuan.
                                                <?php else: ?>
                        ...
                        <ol>
                            ...
                            <li><strong>Periksa API Token:</strong>
                                <ul>
                                    ...
                                    <li>Periksa permission untuk unit management</li>
                                </ul>
                            </li>
        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                $('form').on('submit', function(e) {
                    ...
                    var confirmMessage = 'Apakah Anda yakin ingin menyimpan perubahan satuan ini?\n\n' +
                                       'Kode: ' + kode + '\n' +
                                       'Nama: ' + nama + '\n\n' +
                                       'Perubahan akan disimpan ke database lokal';
                    
                    <?php if (isset($_SESSION['accurate_status']) && $_SESSION['accurate_status'] == 'connected'): ?>
                        confirmMessage += ' dan akan membuat unit baru di Accurate Online.';
                    <?php else: ?>
