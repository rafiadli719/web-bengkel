						...
						<ul class="submenu">
							...
							<li class="">
								...
								<ul class="submenu">
									...
									<li class="">
										<a href="penjualan_mitra_add.php">
											<i class="menu-icon fa fa-caret-right"></i>
											Input Manual
										</a>
										<b class="arrow"></b>
						...
						<ul class="submenu">
							...
							<li class="">
								...
								<ul class="submenu">
									...
									<li class="">
										<a href="lap_antarcab_terima.php">
											<i class="menu-icon fa fa-caret-right"></i>
											Penerimaan
										</a>
										<b class="arrow"></b>
