<?php
	...
	if(empty($_SESSION['_iduser'])){
        ...
        rbac_require_any(array('service_update','input_servis_read','servis_reguler_read','servis_menu_read'));
    ...
    // --------------------				        
        ...
        if(isset($_POST['btnaddworkorder'])) {
            ...
            echo"<script>window.location=('servis-reguler-byr.php?snoserv=$no_service&kd=$txtcaribrg&kdjasa=$txtcarisrv&kdwo=');
            </script>";
        }
        ...
        if(isset($_POST['btnsimpan'])) {	
            ...
            window.location=('servis-reguler-cetak.php?snoserv=$no_service');</script>";                        
        }
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Pembayaran Servis</li>
						</ul><!-- /.breadcrumb -->
					</div>
                        ...
                        <form class="form-horizontal" action="" method="post" role="form">                                            
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-7">
                                    <?php include "_template/_servis_byr_header.php"; ?>                            
                                </div>
                                <div class="col-xs-12 col-sm-5">
                                    <?php include "_template/_servis_byr_header_kanan.php"; ?>                            
                                </div>    
                            </div>
                            ...
                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-sm-4">
                                                    ...
                                                    onclick="return confirm('Keluar dari Form Pembayaran. Lanjutkan?')">                                                                    
