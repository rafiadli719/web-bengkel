                        ...
                        <div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="table-header">
									Jumlah Data Yang ditemukan : <?php echo number_format($tot,0); ?>
								</div>                            
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center"><?php echo $tampil['grup']?><br><?php echo displayStatusMemberBadge(isset($tampil['kategori_member']) ? $tampil['kategori_member'] : 'Bronze'); ?></td>														                                                                                                                
                                        </tr>
                                    <?php
                                        }
                                    ?>
