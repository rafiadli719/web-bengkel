        ...
        if(isset($_POST['btnadd'])) {	
            ...
            if($txtkdbarang<>'') {
                mysqli_query($koneksi,"INSERT INTO tblorder_detail 
                                        (no_item, harga_pokok, quantity, 
                                        total, user) 
                                        VALUES 
                                        ('$txtkdbarang','$txthargabarang','$txtqty',
                                        '$subtotal','$_nama')");
...
<form class="form-horizontal" action="cari_item_pembelian.php" method="post" role="form">
						<div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-5">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            ?>
                                                            <option value='<?php echo $k_id; ?>' <?php if ($k_id == $cbosupplier){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
                                                            <?php
                                                                }
                                                            ?>
                                                            </select>
                        ...
                        <div class="row">
							...
							<div class="col-xs-12 col-sm-5">
                                <div class="form-group">
                                    <label class="col-sm-5 control-label no-padding-right" for="form-field-1"> Sub Total : </label>
                                    <div class="col-sm-7">
                                        <input type="text" id="txttotal" name="txttotal" 
                                        class="col-xs-10 col-sm-12" disabled />
                                    </div>
                                </div>                            
                                <div class="form-group">
                                    <label class="col-sm-5 control-label no-padding-right" for="form-field-1"> Potongan Faktur : </label>
                                    <div class="col-sm-3">
                                        <input type="text" id="txttotal" name="txttotal" 
                                        class="col-xs-10 col-sm-12" />
                                    </div>
