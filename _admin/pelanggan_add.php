						...
						<div class="row">
							<div class="col-xs-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <?php
                                            $sql="select id, panggilan FROM tbpanggilan";
                                            $sql_row=mysqli_query($koneksi,$sql);
                                            while($sql_res=mysqli_fetch_assoc($sql_row))	
                                            {
                                        ?>
                                        <option value="<?php echo $sql_res["id"]; ?>"><?php echo $sql_res["panggilan"]; ?></option>
                                        <?php
                                            }
                                        ?>
                                        </select>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="col-xs-10 col-sm-12" name="cbopot" id="cbopot" required >
                                        <option value="">- Pilih -</option>
                                        <?php
