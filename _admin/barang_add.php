...
<?php include "menu_master01a.php"; ?>
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						<br>
                        <form name="formPendaftaran" class="form-horizontal" action="save_barang.php" method="post" >
						<div class="row">
							<div class="col-xs-6">
 ...
 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" id="txthpokok" name="txthpokok" class="col-xs-10 col-sm-12" 
                                                        required autocomplete="off" />
                                                    </div>
                                                </div>   
                                <hr>
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="number" id="txtqty1b" name="txtqty1b" class="col-xs-2" 
                                        required autocomplete="off" 
                                        onchange="return validateForm()" />
                                        <label class="col-xs-2 control-label no-padding-right" for="form-field-1"> Harga &nbsp;</label>
                                        <input type="number" id="txthj1" name="txthj1" class="col-xs-4" 
                                        required autocomplete="off" 
onchange="return cekhjual1()" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Berdasarkan Jumlah </label>
                                    <div class="col-sm-8">
                                        <input type="number" id="txtqty2a" name="txtqty2a" class="col-xs-2" 
                                        required autocomplete="off" 
                                        onchange="return validateForm1()" />                     
                                        <label class="col-xs-2 control-label no-padding-center" for="form-field-1"> s/d </label>
                                        <input type="number" id="txtqty2b" name="txtqty2b" class="col-xs-2" 
                                        required autocomplete="off" 
                                        onchange="return validateForm2()" />
                                        <label class="col-xs-2 control-label no-padding-right" for="form-field-1"> Harga &nbsp;</label>
                                        <input type="number" id="txthj2" name="txthj2" class="col-xs-4" 
                                        required autocomplete="off" 
onchange="return cekhjual2()" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> &nbsp; </label>
                                    <div class="col-sm-8">
                                        <input type="number" id="txtqty3a" name="txtqty3a" class="col-xs-2" 
                                        required autocomplete="off" 
                                        onchange="return validateForm3()" />
                                        <label class="col-xs-2 control-label no-padding-center" for="form-field-1"> s/d </label>
                                        <input type="text" id="txtqty4b" name="txtqty4b" class="col-xs-2" 
                                        disabled value="Mak" />
                                        <label class="col-xs-2 control-label no-padding-right" for="form-field-1"> Harga &nbsp;</label>
                                        <input type="number" id="txthj3" name="txthj3" class="col-xs-4" 
                                        required autocomplete="off" 
onchange="return cekhjual3()" />
                                    </div>
                                </div>
							</div>									
                        </div>
...
function enabledisabletext()
{
    ...
    <script>
        function validateForm() {
            ...
            qty2 = formPendaftaran.elements["txtqty1b"].valueAsNumber; 
            if (qty2=="0") {
                alert("Jumlah Quantity tidak boleh lebih kecil dari Quantity sebelumnya!");
                document.forms["formPendaftaran"]["txtqty1b"].focus();
                return false;
            }
    ...
    <script>
        function validateForm1() {
            ...
            qty2 = formPendaftaran.elements["txtqty1b"].valueAsNumber; 
            qty3 = formPendaftaran.elements["txtqty2a"].valueAsNumber;             
    ...
    <script>
        function validateForm2() {
            ...
            qty3 = formPendaftaran.elements["txtqty2a"].valueAsNumber; 
            qty4 = formPendaftaran.elements["txtqty2b"].valueAsNumber;             
            
            if (qty4 < qty3) {
                alert("Jumlah Quantity tidak boleh lebih kecil dari Quantity sebelumnya!");
                document.forms["formPendaftaran"]["txtqty2b"].focus();
                return false;
            }
    ...
    <script>
        function validateForm3() {
            ...
            qty4 = formPendaftaran.elements["txtqty2b"].valueAsNumber; 
            qty5 = formPendaftaran.elements["txtqty3a"].valueAsNumber;             
            
            if (qty5 < qty4) {
                alert("Jumlah Quantity tidak boleh lebih kecil dari Quantity sebelumnya!");
                document.forms["formPendaftaran"]["txtqty3a"].focus();
                return false;
            }
    ...
    <script>
        function cekhjual1() {
            ...
            hpokok = formPendaftaran.elements["txthpokok"].valueAsNumber; 
            hjual1 = formPendaftaran.elements["txthj1"].valueAsNumber;             
            
            if (hjual1 < hpokok) {
                alert("Harga Jual Pertama tidak boleh lebih kecil dari Harga Pokok!");
                document.forms["formPendaftaran"]["txthj1"].focus();
                return false;
            }
    ...
    <script>
        function cekhjual2() {
            ...
            hjual1 = formPendaftaran.elements["txthj1"].valueAsNumber;             
            hjual2 = formPendaftaran.elements["txthj2"].valueAsNumber;             
            
            if (hjual2 > hjual1) {
                alert("Harga Jual Kedua tidak boleh lebih besar dari Harga Jual Pertama!");
                document.forms["formPendaftaran"]["txthj2"].focus();
                return false;
            }
    ...
    <script>
        function cekhjual3() {
            ...
            hjual2 = formPendaftaran.elements["txthj2"].valueAsNumber;             
            hjual3 = formPendaftaran.elements["txthj3"].valueAsNumber;             
            
            if (hjual3 > hjual2) {
                alert("Harga Jual Ketiga tidak boleh lebih besar dari Harga Jual Kedua!");
                document.forms["formPendaftaran"]["txthj3"].focus();
                return false;
            }
