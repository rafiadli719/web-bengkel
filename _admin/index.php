                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <table width="100%" border="1">
                                        <?php include "booking_minggu_1.php"; ?>
                                        <?php include "booking_minggu_2.php"; ?>                                        
                                        <?php include "booking_minggu_3.php"; ?>
                                        <?php include "booking_minggu_4.php"; ?> 

                                        <?php  
                                            if($hari=='30') {
                                                include "booking_minggu_5a.php";
                                            }
                                            if($hari=='31') {
                                                include "booking_minggu_5b.php";                                                
                                            }                                            
                                        ?>
                                    </table>
                                </div>
