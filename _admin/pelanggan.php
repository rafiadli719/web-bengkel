<?php
 ...
 // ------- Total Data ----------
		$cari_kd=mysqli_query($koneksi,"SELECT count(nopelanggan) as tot FROM view_cari_pelanggan");			
		$tm_cari=mysqli_fetch_array($cari_kd);
		$total_item=$tm_cari['tot'];				        
        
        $total_item_brg=number_format($total_item,0);
        $hasil_cari="Total Pelanggan : ".$total_item_brg;
...
<?php include "menu_pelanggan01.php"; ?>
									...
									<div class="widget-body">
										<div class="widget-main">	
                                            <form class="form-horizontal" action="" method="post" role="form">
                                                <?php include "_template/cari-pelanggan-header.php"; ?>
                                            </form>
                                        </div>
									</div>
								</div>	
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-default">
                                                        <li>
                                                            <a href="pelanggan_edit.php?kd=<?php echo $row['nopelanggan']?>">Edit Pelanggan</a>
                                                        </li>
                                                        <li>
                                                            <a href="pelanggan_del.php?kd=<?php echo $row['nopelanggan']?>" 
                                                            onclick="return confirm('Data Pelanggan akan dihapus. Lanjutkan?')">Hapus</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a href="pelanggan_awal_piutang.php?kd=<?php echo $row['nopelanggan']?>">Saldo Awal Piutang																
                                                            </a>
                                                        </li>                                                        
                                                    </ul>
                                                </div><!-- /.btn-group -->                                                        
  ...
  <div align="right">
    <ul class="pagination">
      ...
      ?>
        <li<?php echo $linkActive; ?>><a href="pelanggan.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
      <?php
        }
      ?>
